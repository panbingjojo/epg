	...
	class SmartTemplate
	{
		...
		*/
		function debug ( $_top = '' )
		{
			...
			if (@include_once("class.smarttemplate.php"))
			{
				$this-> = new SmartTemplate($this->template_dir . $this->tpl_file);
				$this->->start($_top);
			}
			else
			{
				exit( "SmartTemplate Error: Cannot find class.smarttemplate.php; check SmartTemplate installation");
			}
		}
