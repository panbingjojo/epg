...
abstract class Smarty_Internal_CompileBase {
    ...
    /**
     * Push opening tag name on stack.class
     *
     * Optionally additional data can be saved on stack.class
     *
     * @param object    $compiler   compiler object
     ...
     * Pop closing tag
     *
     * Raise an error if this stack.class-top doesn't match with expected opening tags
     *
     * @param object       $compiler    compiler object
