var parseTemplate = function() {
	var reg = /^(HDV3Formal|SDV3Formal|CHDV3Formal|CSDV3Formal|gdtestHD1|gdtestHD2|gdtestHD3|gdtestSD1|gdtestSD2|gdtestSD3|AAAHD|AAASD)$/im;
	var EPGGroupNMB = Authentication.CTCGetConfig("EPGGroupNMB");
	if (false==reg.test(EPGGroupNMB)) {
		EPGGroupNMB = 'HDV3Formal';
	}

	return EPGGroupNMB;
}
var templateName = parseTemplate();
...
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/'+ templateName +'/en/dibbling.jsp?action=golbalKey</service_url>';
xml += '</response_define>';
xml += '<response_define>';			//直播频道地址
xml += '<key_code>KEY_TV_MENU</key_code>';
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/'+ templateName +'/en/channel.jsp?action=golbalKey</service_url>';
xml += '</response_define>';
xml += '<response_define>';
...
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/'+ templateName +'/en/playback.jsp?action=golbalKey</service_url>';
xml += '</response_define>';
xml += '<response_define>';
...
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/'+ templateName +'/en/space_collect.jsp?action=golbalKey</service_url>';
xml += '</response_define>';
xml += '<response_define>';
