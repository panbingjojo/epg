        ...
        var Activity = {
            ...
            startGame: function () {
                ...
                if (!Activity.gameOverFlag) {
                    ...
                    Activity.roadTimer = setInterval(Activity.roadChange, 500);
                }

            },
            roadChange: function () {
                Activity.roadIndex = Activity.roadIndex == 3 ? 2 : Activity.roadIndex + 1;
                G('road').src = r.imagePath + '/road' + Activity.roadIndex + '.png';
            },
            catChange: function () {
                Activity.catIndex = Activity.catIndex == 3 ? 2 : Activity.catIndex + 1;
                G('cat').src = r.imagePath + '/cat' + Activity.catIndex + '.png';
            },
            pickUp: function (direction) {
                ...
                LMEPG.UI.forbidDoubleClickBtn(function () {
                    if (Activity.playStatus) {
                        if (Activity.clickNum == 0) {
                            Activity.catChange();
                            Activity.catTimer = setInterval(Activity.catChange, 500);
                        }
                        Activity.clickNum++;
                        LMEPG.UI.showToast('+' + Activity.clickNum, 1);
                    }
                }, 500);
                return false;
            },
            ...
            ActivityCountDown: function () {
                ...
                if (gameTime <= 0) {
                    ...
                    clearInterval(Activity.roadTimer);
            ...
            checkGameResult: function () {
                ...
                if (Activity.clickNum > 0) {
                    ...
                    G("add_count").innerHTML = Activity.clickNum;
                    G("score_num").innerHTML = Activity.clickNum;
