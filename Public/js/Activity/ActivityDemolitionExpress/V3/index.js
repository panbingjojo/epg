(function (w, e, r, a) {
    var Activity = {
        ...
        initButtons: function () {
            e.BM.init('btn_left', Activity.buttons, true);
        },

        initDiffImg: function(){
            if(r.lmcid == '520094'){
                G('body').style.backgroundImage = 'url(' + r.imagePath + 'bg_home1.png)';
                G('btn_left').src = r.imagePath + 'btn_aqy.png';
            }
        },
        startGame: function () {
            G('btn_start').src = r.imagePath + 'jump_start_active.gif';
        ...
        checkGameResult: function (prizeId) {
            ...
            var getPrize = [1, 3, 6]; // 配置的中奖ID 分别对应1,2,3 等奖
            if (getPrize.indexOf(prize_id) !== -1) {
                ...
                $('prize_image').src = LMActivity.prizeImage[prize_id];
                setTimeout(function () {
        ...
        eventHandler: function (btn) {
            switch (btn.id) {
                ...
                case 'btn_order_vip':
                    ...
                    break;
                case 'btn_order_id_sure':
                    a.showModal({
                        id: 'bg_order_tel',
                        focusId: 'btn_order_tel_sure',
                    })
                    break;
    ...
    Activity.buttons = [
        {
            ...
            name: '按钮-首页领礼包',
            type: 'img',
            nextFocusLeft: 'btn_activity',
            nextFocusRight: 'btn_area',
            backgroundImage: r.lmcid == '520094'? a.makeImageUrl('btn_aqy.png'):a.makeImageUrl('btn_year_gift.png'),
            focusImage: r.lmcid == '520094'? a.makeImageUrl('btn_aqy_f.png'):a.makeImageUrl('btn_year_gift_f.png'),
            ...
            nextFocusRight: 'btn_activity',
            backgroundImage: a.makeImageUrl('btn_area.png'),
            focusImage: a.makeImageUrl('btn_area_f.png'),
            click: Activity.eventHandler
        },{
            id: 'btn_activity',
            name: '按钮-参加活动',
            type: 'img',
            nextFocusLeft: 'btn_area',
            nextFocusRight: 'btn_left',
            backgroundImage: a.makeImageUrl('btn_activity.png'),
            focusImage: a.makeImageUrl('btn_activity_f.png'),
            click: Activity.eventHandler
        },{
            ...
            focusImage: a.makeImageUrl('btn_iknow_f.png'),
            click: Activity.eventHandler
        },{
            id: 'btn_lottery',
            name: '按钮-立即抽奖',
            ...
            id: 'btn_order_tel_sure',
            name: '领礼包手机号-确定',
            type: 'img',
            nextFocusUp: 'order_tel',
            backgroundImage: a.makeImageUrl('btn_common_sure.png'),
            focusImage: a.makeImageUrl('btn_common_sure_f.png'),
            click: Activity.eventHandler
        },{
            ...
            name: '按钮-去订购',
            type: 'img',
            backgroundImage: a.makeImageUrl('btn_order_vip.png'),
            focusImage: a.makeImageUrl('btn_order_vip_f.png'),
            click: Activity.eventHandler
        },{
            id: 'btn_back',
            name: '按钮-返回',
    ...
    w.onBack = function () {
        if (LMActivity.shownModal) {
            ...
            } else if(LMActivity.shownModal.id =='activity_rule' || LMActivity.shownModal.id =='winner_list'|| LMActivity.shownModal.id =='lottery_success'
                || LMActivity.shownModal.id =='lottery_fail'|| LMActivity.shownModal.id =='order_vip'){
                LMActivity.showModal({
                    id: 'game_container',
                    focusId: 'btn_start'
                });
