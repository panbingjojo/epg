(function (w, e, r, a) {
    var Activity = {
        ...
        playGame: function () {
            ...
            G("animal-car").src = a.makeImageUrl('icon_car_sport.gif');
            LMEPG.ButtonManager.setKeyEventPause(true);
            carRun.init();
            setTimeout("Activity.doAddScore(5)", 3000);
        },
    ...
    Activity.buttons = [
        {
            ...
            focusImage: a.makeImageUrl('btn_home_back_f.gif'),
            click: a.eventHandler
        }, {
            ...
            focusImage: a.makeImageUrl('btn_exchange_prize_f.gif'),
            ...
            focusImage: a.makeImageUrl('jump_knowledge_f.gif'),
        ...
        },
        {
            ...
            focusImage: a.makeImageUrl('btn_play_f.gif'),
            click: Activity.eventHandler
        }, {
