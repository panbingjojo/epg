(function (w, e, r, a) {
        var Activity = {
            ...
            eventHandler: function (btn) {
                var jumpUrl = LMEPG.STBUtil.getEPGDomain();
                LMEPG.Log.info('jumpUrl222222222222'+jumpUrl)
                jumpUrl = jumpUrl.substring(0,jumpUrl.indexOf('iptvepg'));
                switch (btn.id) {
                    case 'btn_back':
                    ...
                    case 'lipstick1':
                        ...
                        break;
                    //跳转抢鲜看
                    case 'btn_product_qxk':
                        Activity.jumpThirdPartyUrl(jumpUrl +
                            'iptvepg/frame1121/ITVBESTV/epgEntry.jsp?jumpUrl=epg2vas.jsp?thirdurl=http://10.255.1.215/vasroot/viscore/portal/biz_hq_11102098&backUrl=http%3A%2F%2F10.255.128.15%3A8080%2Fiptvepg%2Fframe1121%2Fduocaiguizhou%2FBSLauncher%2Fportal.html');
                        break;
                    //跳转39健康
                    case 'btn_product_39jk':
                        Activity.jumpThirdPartyUrl(jumpUrl +
                            'iptvepg/frame1121/39jiankang_Online/39jiankang/39jiankang/index.html?backUrl=http%3A%2F%2F10.255.128.15%3A8080%2Fiptvepg%2Fframe1121%2Fduocaiguizhou%2FBSLauncher%2Fportal.html');
                        break;

                    //跳转电竞风暴
                    case 'btn_product_djfb':
                        Activity.jumpThirdPartyUrl(jumpUrl +
                            'iptvepg/frame1121/ITVBESTV/epgEntry.jsp?jumpUrl=epg2vas.jsp?thirdurl=http://10.255.1.215/vasroot/viscore/portal/biz_hq_12249906_hd&backUrl=http%3A%2F%2F10.255.128.15%3A8080%2Fiptvepg%2Fframe1121%2Fduocaiguizhou%2FBSLauncher%2Fportal.html');
                        break;
                    //跳转贝瓦乐园
                    case 'btn_product_bwly':
                        Activity.jumpThirdPartyUrl(jumpUrl +
                            'iptvepg/frame1121/ITVBESTV/epgEntry.jsp?jumpUrl=epg2vas.jsp?thirdurl=http://10.255.1.215/vasroot/viscore/portal/biz_hq_11239917&backUrl=http%3A%2F%2F10.255.128.15%3A8080%2Fiptvepg%2Fframe1121%2Fduocaiguizhou%2FBSLauncher%2Fportal.html');
                        break;
            ...
            jumpThirdPartyUrl: function (url) {
                LMEPG.Log.info('url1111111111111111'+url)
                // 返回当前页面的URL
        ...
        Activity.buttons = [
            {
                ...
                name: '抢鲜看',
                type: 'img',
                nextFocusLeft: 'btn_product_bwly',
                nextFocusUp: 'lipstick1',
                nextFocusDown: '',
                nextFocusRight:'btn_product_39jk',
                backgroundImage: a.makeImageUrl('btn_product_qxk.png'),
                focusImage: a.makeImageUrl('btn_product_qxk_f.png'),
                click: Activity.eventHandler
            }, {
                id: 'btn_product_39jk',
                name: '39健康',
                type: 'img',
                nextFocusLeft: 'btn_product_qxk',
                nextFocusUp: 'lipstick1',
                nextFocusDown: '',
                nextFocusRight:'btn_product_djfb',
                backgroundImage: a.makeImageUrl('btn_product_39jk.png'),
                focusImage: a.makeImageUrl('btn_product_39jk_f.png'),
                click: Activity.eventHandler
            }, {
                id: 'btn_product_djfb',
                name: '点燃烟花',
                type: 'img',
                nextFocusLeft: 'btn_product_39jk',
                nextFocusUp: 'lipstick1',
                nextFocusDown: '',
                nextFocusRight:'btn_product_bwly',
                backgroundImage: a.makeImageUrl('btn_product_djfb.png'),
                focusImage: a.makeImageUrl('btn_product_djfb_f.png'),
                click: Activity.eventHandler
            }, {
                id: 'btn_product_bwly',
                name: '点燃烟花',
                type: 'img',
                nextFocusLeft: 'btn_product_djfb',
                nextFocusUp: 'lipstick1',
                nextFocusDown: '',
                nextFocusRight:'btn_product_qxk',
                backgroundImage: a.makeImageUrl('btn_product_bwly.png'),
                focusImage: a.makeImageUrl('btn_product_bwly_f.png'),
                click: Activity.eventHandler
            }, {
                id: 'btn_list_submit',
                name: '按钮-中奖名单-确定',
