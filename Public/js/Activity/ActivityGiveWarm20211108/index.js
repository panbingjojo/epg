(function (w, e, r, a) {
        var Activity = {
            ...
            initGamePic:function(){
                for(var i=1; i<=21; i++){
                    var img = new Image()
                    img.src= a.makeImageUrl('wheel_'+i+'.png');
                }
            },
        ...
        Activity.game=(function () {
            ...
            function roll() {
                ...
                var rollN = 0; // 圈数
                var imageEl = G('lipstick1');
                var rollCircle = parseInt(Math.random()*(42-21+1)+21,10);
            ...
            function getFillCircle(rollCircle) {
                ...
                if(result === 0){
                    ...
                    }else if(restCircle > 2 ){
                        return rollCircle - (restCircle-2)
                    }
                    ...
                    }else if(restCircle > 6){
                        return rollCircle-(restCircle-6)
                    }
                    ...
                    if(restCircle < 6){
                        return rollCircle+(6-restCircle)
