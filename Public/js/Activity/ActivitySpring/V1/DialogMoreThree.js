...
(function () {
    ...
    var createActivity = function (platformType) {
        var _html = '';
        _html += '<div ><img id="default_focus" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/activity_rules_unicom_.png" onfocusurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/activity_rules_unicom_.png" confirmurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/activity_rules_unicom_.png"/>';
        _html += '</div>';
    ...
    var createUnVip320092 = function (platformType, n, bg) {
        ...
        if (platformType == "hd") {
            ...
            if (bg == "play") {
                _html += '<div ><img id="default_focus" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/unvip_book__game_320092_.png"/>';//标清背景
            } else {
                _html += '<div ><img id="default_focus" style="position: absolute;top: 0px;" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/unvip_book_320092_.png"/>';//标清背景
            }
        }
        _html += '<img id="tips" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/tips_' + n + '.png"/>';
        if (platformType == "hd") {
    ...
    var createUnVip = function (platformType, n, bg) {
        ...
        if (platformType == "hd") {
            if (bg == "play") {
                ...
                _html += '<img id="focus-6-1" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/add_vip_out.png" style="position: absolute;top: 530px;left: 520px;" onfocusurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/add_vip_in.png" confirmurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/add_vip_out.png"/>';
            } else {
                _html += '<div ><img id="default_focus" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/unvip_book_320092_.png"/>';
                _html += '<img id="focus-6-1" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/add_vip_out.png" style="position: absolute;top: 500px;left: 520px;" onfocusurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/add_vip_in.png" confirmurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/add_vip_out.png"/>';
            }
    ...
    var createPlay = function (platformType, n) {
        var _html = '';
        _html += '<div ><img id="default_focus" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/price_is_null_unicom_.png"/>';
        _html += '<img id="focus-7-1" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/back_out.png" onfocusurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/back_in.png" confirmurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/back_out.png"/>';
    ...
    var createPhone = function (platformType) {
        var _html = '';
        _html += '<div ><img id="default_focus" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/wrrite_phone_.png"/>';
        _html += '<img id="focus-8-1" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/back_guide_out.png" onfocusurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/back_guide_in.png" confirmurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/back_guide_out.png"/>';
        _html += '<img id="focus-10-1" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/save_out.png" onfocusurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/save_in.png" confirmurl="/Public/' + platformType + '/img/Activity/ActivitySpring/V1/save_out.png"/>';
        _html += '<input id="focus-9-1" type="text"  placeholder="请输入正确的电话号码"/>';
        _html += '</div>';
        dialog.innerHTML = _html;
        G("focus-9-1").focus();
    ...
    var createPrice = function (platformType, prizeName, n) {
        var _html = '';
        _html += '<img id="tips" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/tips_' + n + '.png"/>';
        _html += '<div ><img id="default_focus" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivitySpring/V1/winning_unicom_.png"/>';//高清背景
