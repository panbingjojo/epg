        ...
        jumpBack: function () {
            ...
            if (Activity.animate.isStart) {
                ...
                if (self.checkUserInfo()) {
                    ...
                    if (Activity.isSurePayModal && TP.cdCount != '-1') {
                        self.reload();
                    } else {
                        epg.Intent.back();
                    }
        ...
        animate: {
            ...
            gameCD: function () {
                ...
                (function cd() {
                    ...
                    console.log('Activity.animate.CD==>' + Activity.animate.CD, 'count==>' + count);
                    if (count === 0) {
            ...
            obsMove: function (randEl, obsT) {
                ...
                var moveY = obsT;
                (function loop() {
                    moveY = Math.max(_this.minY - _this.obsHeight, moveY -= 5);
                    randEl.style.top = moveY + 'px';
                    obsTimer = setTimeout(loop, 30);
            ...
            movePerson: function (key, btn) {
                ...
                var moveLeft = function () {
                    _this.penLeft = Math.max(_this.minX, _this.penLeft -= 30);
                };

                var moveRight = function () {
                    _this.penLeft = Math.min(_this.maxX, _this.penLeft += 30);
                };
