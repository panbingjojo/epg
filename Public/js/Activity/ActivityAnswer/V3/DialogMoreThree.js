...
(function () {
    ...
    var CreateSuccess = function (resolution) {
         ...
         */
        if (resolution == "hd") {
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V3/success_bg.png"/>';
            ...
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/sd/Activity/ActivityAnswer/V3/success_bg.png"/>';
            _html += '<div class="introduce-success">恭喜您获得一个宝箱！赶快打开吧~<br/></div>';
    ...
    var createActivity = function (resolution) {
        ...
        if (resolution == "hd") {
            ...
            _html += '<img  class="price_three" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V3/price_three.png"/>';
            _html += '<img  class="price_four" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V3/price_four.png"/>';
            _html += '<div class="detail-text">1.凡在活动期间，包月用户每天有3次答题抽奖机会，当日获奖机会，当天24点清零。<br/>';
            _html += '2.未订购“远程医疗”业务的用户每天获赠1次试玩机会，成功订购业务后即可答题抽奖。<br/>';
            _html += '3.活动奖品以实物为准，图片只作参考，获奖用户需填写联系手机号码，活动结束后15个工作日';
            _html += '与其联系确认奖品信息及奖品发放，并统一邮寄实物奖品。<br/>';
            _html += '4.获奖用户未正确填写手机号码或未填写手机号码，则视为自主放弃领奖。</div>';
        } else {
    ...
    var CreateFalse = function (resolution, isCanAnswer) {
         ...
         */
        if (resolution == "hd") {
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V3/fault_bg.png"/>';
            _html += '<img id="btn-one" class="btn-only" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V1/fault_in.gif" >';
        } else {
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/sd/Activity/ActivityAnswer/V3/fault_bg.png"/>';
        ...
        if(isCanAnswer){
            ...
            _html += '<div class="introduce">真遗憾，答错了！<br/>请明天再来挑战！</div>';
            focusType = "back";
        }
        _html += '</div>';
        dialog.innerHTML = _html;
    ...
    var createTime = function (resolution) {
         ...
         */
        if (resolution == "hd") {
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V3/warm_bg.png"/>';
            _html += '<div class="introduce">今日答题次数已用完<br/>请明天再来挑战吧!<br/></div>';
            _html += '<img id="btn-one" class="btn-only" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V1/fault_in.gif" >';
        } else {
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/sd/Activity/ActivityAnswer/V3/warm_bg.png"/>';
            _html += '<div class="introduce">今日答题次数已用完<br/>请明天再来挑战吧!<br/></div>';
            _html += '<img id="btn-one" class="btn-only" src="__ROOT__/Public/img/sd/Activity/ActivityAnswer/V1/fault_in.gif" >';
        }
        _html += '</div>';
    ...
    var createPhone = function (resolution, name) {
         ...
         */
        if (resolution == "hd") {
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/hd/Activity/ActivityAnswer/V3/win_price_bg.png"/>';
            ...
            _html += '<input id="searchText" placeholder="请填写正确的手机号"/>';
            ...
            _html += '<div ><img id="default_focus" src="__ROOT__/Public/img/sd/Activity/ActivityAnswer/V3/win_price_bg.png"/>';
            _html += '<div class="introduce-price-text">恭喜您获得：<span class="introduce-price-name">' + name + '</span></div>';
            _html += '<div id="myPhone">请英雄留下您的联系方式</div>';
            _html += '<input id="searchText" placeholder="请填写正确的手机号"/>';
