...
(function () {
    ...
    var createActivity = function (resolution) {
        ...
        if (resolution == "hd") {
            ...
            _html += '<tr><td>1.活动期间,未订购“39健康”的用户，每天获赠1次试玩机会，且不能抽奖，成功订购业务成为包月用户后即可答题抽奖，订购用户每天有3次答题抽奖机会，所有抽奖机会当日有效次日作废。</td></tr>';
            _html += '<tr><td></td></tr>';
            _html += '<tr><td>2.活动奖品以实物为准，图片只作参考，工作人员将在活动结束后15个工作日内与获奖用户联系，统一邮寄实物奖品。</td></tr>';
            _html += '<tr><td></td></tr>';
            _html += '<tr><td>3.获奖用户未正确填写电话号码或未填写电话号码，则视为自主放弃领奖。</td></tr>';
            _html += '</table>';
        } else {
