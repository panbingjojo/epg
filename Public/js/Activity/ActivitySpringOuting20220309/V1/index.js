(function (w, e, r, a) {
    var Activity = {
        ...
        initButtons: function () {
            e.BM.init('btn_riceShoots', Activity.buttons, true);
        },
        ...
        eventHandler: function (btn) {
            switch (btn.id) {
                ...
                case 'btn_order_submit': //订购按钮
                    ...
                    break;
                case 'btn_riceShoots':
                case 'btn_peachBlossom':
                case 'btn_cobblestone':
                case 'btn_wicker':
                    a.triggerModalButton = btn.id;
                    if (a.hasLeftTime()) {
                        a.AjaxHandler.uploadPlayRecord(function () {
                            if (LMActivity.playStatus = 'false') {
                                Activity.gameResult(btn.botany);
                            }
                        }, function () {
                ...
                case 'btn_game_sure_riceShoots':
                case 'btn_game_sure_cobblestone':
                case 'btn_game_sure_peachBlossom':
                case 'btn_game_sure_wicker':
         ...
         * 检查游戏状态
         * */
        gameResult: function (temp) {
            G('count_riceShoots').innerHTML = '1';
            G('count_cobblestone').innerHTML = '1';
            G('count_peachBlossom').innerHTML = '1';
            G('count_wicker').innerHTML = '1';
            a.AjaxHandler.addScore(parseInt(Activity.score), function () {
                switch (temp) {
                    case 'riceShoots':
                        a.showModal({
                            id: 'game_success_riceShoots',
                            focusId: 'btn_game_sure_riceShoots',
                            onDismissListener: function () {
                    ...
                    case 'cobblestone':
                        a.showModal({
                            id: 'game_success_cobblestone',
                            focusId: 'btn_game_sure_cobblestone',
                            onDismissListener: function () {
                                a.Router.reload(); // 重新加载
                            }
                        });
                    ...
                    case 'peachBlossom':
                        a.showModal({
                            id: 'game_success_peachBlossom',
                            focusId: 'btn_game_sure_peachBlossom',
                            onDismissListener: function () {
                                a.Router.reload(); // 重新加载
                            }
                        });
                    ...
                    case 'wicker':
                        a.showModal({
                            id: 'game_success_wicker',
                            focusId: 'btn_game_sure_wicker',
                            onDismissListener: function () {
                                a.Router.reload(); // 重新加载
                            }
                        });
    ...
    Activity.buttons = [
        {
            ...
            name: '按钮-返回',
            type: 'img',
            nextFocusLeft: 'btn_riceShoots',
            nextFocusDown: 'btn_riceShoots',
            ...
            nextFocusDown: 'btn_cobblestone',
            nextFocusRight: 'btn_peachBlossom',
            nextFocusLeft: 'btn_cobblestone',
            botany: 'riceShoots',
            backgroundImage: a.makeImageUrl('btn_riceShoots.png'),
            focusImage: a.makeImageUrl('btn_riceShoots_f.png'),
            click: Activity.eventHandler
        }, {
            id: 'btn_cobblestone',
            name: '鹅卵石',
            type: 'img',
            nextFocusUp: 'btn_riceShoots',
            nextFocusDown: 'btn_wicker',
            nextFocusRight: 'btn_peachBlossom',
            botany: 'cobblestone',
            backgroundImage: a.makeImageUrl('btn_cobblestone.png'),
            focusImage: a.makeImageUrl('btn_cobblestone_f.png'),
            click: Activity.eventHandler
        }, {
            id: 'btn_peachBlossom',
            name: '桃花枝',
            ...
            botany: 'peachBlossom',
            backgroundImage: a.makeImageUrl('btn_peachBlossom.png'),
            focusImage: a.makeImageUrl('btn_peachBlossom_f.png'),
            click: Activity.eventHandler
        }, {
            id: 'btn_wicker',
            name: '柳条',
            type: 'img',
            nextFocusUp: 'btn_peachBlossom',
            nextFocusRight: 'btn_peachBlossom',
            nextFocusLeft: 'btn_cobblestone',
            botany: 'wicker',
            backgroundImage: a.makeImageUrl('btn_wicker.png'),
            focusImage: a.makeImageUrl('btn_wicker_f.png'),
            click: Activity.eventHandler
        }, {
            id: 'btn_list_submit',
            name: '按钮-中奖名单-确定',
...
var specialBackArea = ['460092', "410092", '10220094', '10220095'];
