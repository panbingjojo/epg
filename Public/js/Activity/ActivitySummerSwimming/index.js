...
(function (w, e, r, a) {
        var Activity = {
             ...
             */
            initImages: function () {
                r.carrierId == '430002' && Activity.initImages430002()
            },

            /**
             * 湖南电信定制化图片
             */
            initImages430002: function () {
                G('btn_back').src = Activity.getImageUrl('btn_back.png')
                G('btn_activity_rule').src = Activity.getImageUrl('btn_activity_rule.png')
                G('btn_winner_list').src = Activity.getImageUrl('btn_winner_list.png')
                G('btn_exchange_prize').src = Activity.getImageUrl('btn_exchange_prize.png')
                G('btn_list_cancel').src = Activity.getImageUrl('btn_common_cancel.png')
                G('exchange_prize_1').src = Activity.getImageUrl('btn_exchange_enable.png')
                G('exchange_prize_2').src = Activity.getImageUrl('btn_exchange_enable.png')
                G('exchange_prize_3').src = Activity.getImageUrl('btn_exchange_enable.png')
                G('btn_exchange_cancel').src = Activity.getImageUrl('btn_common_cancel.png')
            },
            ...
            setGameInterval: function (tipsNum) {
                G("tips").innerHTML = "READY!!!";
                Activity.playStatus = true;
                return setInterval(function () {
                    G("tips").innerHTML = "GO!!!";
                    G("tips").style.left = "532px"
                    if (tipsNum <= 0) {
                        G("tips").innerHTML = "";
             ...
             */
            startGame: function () {
                G("bg_game_container").style.display = "none";
                G("bg_game_container1").style.display = "block"
            },
            ...
            ActivityCountDown: function () {
                ...
                if (gameTime <= 0) {
                    ...
                    G("bg_game_container1").style.display = "none";
                    G("bg_game_container").style.display = "block";
                    Activity.playStatus = false;
             ...
             * 倒计时小于6时，改变数字样式
             */
            changeCountdownCss:function (){
                G('game_countdown').style.fontSize = '100px'
                G('game_countdown').style.color = '#FF5D69'
            },
            ...
            updateCountPosition:function (){
                if (Activity.clickNum < 15) {
                    G("add_count").innerHTML = 1;
                    G("position").innerHTML = 3
                } else if (Activity.clickNum < 30) {
                    G("add_count").innerHTML = 2;
                    G("position").innerHTML = 2
                } else {
                    G("add_count").innerHTML = 3;
                    G("position").innerHTML = 1
                }
            },
            ...
            getImageUrl: function (imageName) {
                var url = a.makeImageUrl(imageName)
                r.carrierId == '430002' && (url = r.imagePath + 'V' + r.carrierId + '/' + imageName)
                return url
            }
        ...
        Activity.buttons = [
            {
                ...
                backgroundImage: Activity.getImageUrl('btn_back.png'),
                focusImage: Activity.getImageUrl('btn_back_f.png'),
                ...
                backgroundImage: Activity.getImageUrl('btn_activity_rule.png'),
                focusImage: Activity.getImageUrl('btn_activity_rule_f.png'),
                ...
                backgroundImage: Activity.getImageUrl('btn_winner_list.png'),
                focusImage: Activity.getImageUrl('btn_winner_list_f.png'),
                listType: 'exchange',
                click: a.eventHandler
            }, {
                id: 'btn_game_sure',
                name: '按钮-中奖名单',
                type: 'img',
                backgroundImage: Activity.getImageUrl('btn_common_sure.png'),
                focusImage: Activity.getImageUrl('btn_common_sure_f.png'),
                listType: 'lottery',
                click: Activity.eventHandler
            }, {
                ...
                backgroundImage: Activity.getImageUrl('btn_start.png'),
                focusImage: Activity.getImageUrl('btn_start_f.png'),
                click: Activity.eventHandler
            }, {
                ...
                backgroundImage: Activity.getImageUrl('btn_exchange_enable.png'),
                focusImage: Activity.getImageUrl('btn_exchange_enable_f.png'),
                click: a.eventHandler
            }, {
                id: 'exchange_prize_2',
                name: '按钮-兑换2',
                ...
                backgroundImage: Activity.getImageUrl('btn_common_cancel.png'),
                focusImage: Activity.getImageUrl('btn_common_cancel_f.png'),
                click: a.eventHandler
            }, {
                id: 'btn_list_submit',
                name: '按钮-中奖名单-确定',
                ...
                nextFocusLeft: '',
                nextFocusRight: '',
                backgroundImage: Activity.getImageUrl('btn_begin.gif'),
                focusImage: Activity.getImageUrl('btn_begin.gif'),
                click: Activity.eventHandler
            }
        ];
        var Pagination = {
...
var specialBackArea = ['460092', "410092"];

/**
 * 退出，返回
 */
function outBack() {
    if (RenderParam.lmcid == '460092' || RenderParam.lmcid == '410092') {
