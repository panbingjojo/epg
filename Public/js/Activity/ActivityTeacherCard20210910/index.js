        ...
        var Activity = {
            ...
            eventHandler: function (btn) {
                switch (btn.id) {
                    ...
                    case 'blessing3':
                    case 'blessing4':
                        G('blessing-content').src=btn.src;
                        if (G('card-content').src.lastIndexOf('.png') != -1 &&
                            G('blessing-content').src.lastIndexOf('.png') != -1) {
                            LMEPG.BM.requestFocus('btn_send');
                        } else {
                            LMEPG.BM.requestFocus('card_model1');
                        }
                        break;
                    case 'btn_send':
                        a.doLottery();
            ...
            onInputFocus: function (btn, hasFocus) {
                if (hasFocus) {
                    ...
                    /*G("reset_tel").style.color = '#333333';
                    G("reset_tel").style.fontWeight = 'bold';*/
                }
            },
        ...
        Activity.buttons = [
            {
                ...
                name: '贺卡-1',
                type: 'img',
                nextFocusRight: 'blessing1',
                nextFocusDown: 'card_model2',
                backgroundImage: a.makeImageUrl('card_model1.png'),
                focusImage: a.makeImageUrl('card_model1_f.png'),
                src: a.makeImageUrl('card_model1_content.png'),
                click: Activity.eventHandler
            }, {
                id: 'card_model2',
                name: '贺卡-2',
                type: 'img',
                nextFocusRight: 'blessing1',
                nextFocusUp: 'card_model1',
                nextFocusDown: 'card_model3',
                backgroundImage: a.makeImageUrl('card_model2.png'),
                focusImage: a.makeImageUrl('card_model2_f.png'),
                src: a.makeImageUrl('card_model2_content.png'),
                click: Activity.eventHandler
            }, {
                id: 'card_model3',
                name: '贺卡-3',
                type: 'img',
                nextFocusRight: 'blessing1',
                nextFocusUp: 'card_model2',
                nextFocusDown: 'card_model4',
                backgroundImage: a.makeImageUrl('card_model3.png'),
                focusImage: a.makeImageUrl('card_model3_f.png'),
                src: a.makeImageUrl('card_model3_content.png'),
                click: Activity.eventHandler
            }, {
                id: 'card_model4',
                name: '贺卡-4',
                type: 'img',
                nextFocusRight: 'blessing1',
                nextFocusUp: 'card_model3',
                backgroundImage: a.makeImageUrl('card_model4.png'),
                focusImage: a.makeImageUrl('card_model4_f.png'),
                src: a.makeImageUrl('card_model4_content.png'),
                beforeMoveChange:Activity.canDown,
                click: Activity.eventHandler
            }, {
                id: 'blessing1',
                name: '祝福语-1',
                type: 'img',
                nextFocusLeft: 'card_model1',
                nextFocusRight: 'blessing2',
                nextFocusDown: 'blessing3',
                backgroundImage: a.makeImageUrl('blessing1.png'),
                focusImage: a.makeImageUrl('blessing1_f.png'),
                src: a.makeImageUrl('blessing1_content.png'),
                click: Activity.eventHandler
            }, {
                id: 'blessing2',
                name: '祝福语-2',
                type: 'img',
                nextFocusLeft: 'blessing1',
                nextFocusDown: 'blessing4',
                backgroundImage: a.makeImageUrl('blessing2.png'),
                focusImage: a.makeImageUrl('blessing2_f.png'),
                src: a.makeImageUrl('blessing2_content.png'),
                click: Activity.eventHandler
            }, {
                id: 'blessing3',
                name: '祝福语-3',
                type: 'img',
                nextFocusLeft: 'card_model1',
                nextFocusRight: 'blessing4',
                nextFocusUp: 'blessing1',
                backgroundImage: a.makeImageUrl('blessing3.png'),
                focusImage: a.makeImageUrl('blessing3_f.png'),
                src: a.makeImageUrl('blessing3_content.png'),
                beforeMoveChange:Activity.canDown,
                click: Activity.eventHandler
            }, {
                id: 'blessing4',
                name: '祝福语-4',
                type: 'img',
                nextFocusLeft: 'blessing3',
                nextFocusUp: 'blessing2',
                backgroundImage: a.makeImageUrl('blessing4.png'),
                focusImage: a.makeImageUrl('blessing4_f.png'),
                src: a.makeImageUrl('blessing4_content.png'),
                beforeMoveChange:Activity.canDown,
                click: Activity.eventHandler
            }, {
                id: 'btn_send',
                name: '送出贺卡',
                type: 'img',
                nextFocusUp: 'card_model4',
                nextFocusRight: 'blessing1',
                backgroundImage: a.makeImageUrl('btn_send.png'),
                focusImage: a.makeImageUrl('btn_send_f.png'),
                click: Activity.eventHandler
            }
        ];
