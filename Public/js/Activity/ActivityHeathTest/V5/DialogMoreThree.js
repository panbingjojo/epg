(function () {
    ...
    var createActivity = function () {
        var _html = "";
        _html += '<div ><img id="default_focus" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivityHeathTest/V5/bg_rule.png"/>';
    ...
    var createPhone = function (platformType, prizeName) {
        ...
        _html += '<img id="goods" class="commonPosition" src="__ROOT__/Public/' + platformType + '/img/Activity/ActivityHeathTest/V5/' + prizeName + '"  onfocusurl="__ROOT__/Public/img/sd/Activity/ActivityHeathTest/V5/confirm_in.png" confirmurl="__ROOT__/Public/img/sd/Activity/ActivityHeathTest/V5/confirm_out.png" >';
