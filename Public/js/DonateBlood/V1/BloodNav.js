var DonateBlood = {
    maxPage: 0,
    videoList: RenderParam.carrierId == '640094' ? [665,664] : [315, 316],//正式服图文ID
    //videoList:[3487,3488],        //测试服图文ID
    ...
    getCurrentPage: function () {
        var obj = LMEPG.Intent.createIntent('bloodNav');
    ...
    createBtns: function () {
        ...
        LMEPG.BM.init(LMEPG.Func.getLocationString('focusId') || 'btn_bxzy', buttons, true);
