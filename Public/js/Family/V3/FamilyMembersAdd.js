...
function initMemberUI() {
    try {
        eleTitle.innerHTML = parseInt(RenderParam.initMemberID) > 0 ? '编辑家庭成员信息' : '添加家庭成员信息';
        ...
        if (memberArray.length > 0) {
            ...
            memberArrayIndex = 0;
            if (RenderParam.initMemberID > 0) {
                LMEPG.BM.init('focus-1-2', buttons, '', true);
...
function addMember() {
    ...
    var postData = {
        'member_id': RenderParam.initMemberID,
