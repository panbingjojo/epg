var Member = {
        ...
        updateMemberUI: function (btn) {
            ...
            currData.forEach(function (t, i) {
                    if (LMEPG.Func.isEmpty(t) || t.member_id == 0) {
                        htm += '<img id="focus-' + i + '" src="' + g_appRootPath + '/Public/img/hd/Family/V16/add_icon.png">';
                    } else {
                        htm += '<img id="focus-' + i + '" src="' + g_appRootPath + '/Public/img/hd/Family/V16/member_' + t.member_image_id + '.png">';
                    }
        ...
        createBtns: function () {
            this.buttons.push({
                ...
                focusImage: g_appRootPath + '/Public/img/hd/Family/V16/member_radius_f.png',
                ...
                focusImage: g_appRootPath + '/Public/img/hd/Family/V16/data_archiving_f.png',
                backgroundImage: g_appRootPath + '/Public/img/hd/Family/V16/data_archiving.png',
                ...
                focusImage: g_appRootPath + '/Public/img/hd/Family/V16/ask_record_f.png',
                backgroundImage: g_appRootPath + '/Public/img/hd/Family/V16/ask_record.png',
