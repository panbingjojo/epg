var SplashRouteConstants = {
    ...
    ROUTE_HEALTH_DETECTION: 110, // 健康检测页
    ROUTE_MY_FAMILY: 111, // 我的家
...
LMSplashRouter.routeAreaModule = function (routeFlag) {
    switch (routeFlag) {
        ...
        case SplashRouteConstants.ROUTE_HEALTH_DETECTION:
            LMSplashRouter.routeHealthDetection();
            break;
        case SplashRouteConstants.ROUTE_MY_FAMILY:
            LMSplashRouter.routeMyFamily();
            break;
    }
}
