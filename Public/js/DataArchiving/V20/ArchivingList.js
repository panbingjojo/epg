...
var DataArchive = {
    ...
    nullAskRecordData: function () {
        ...
        htm += '<tr><td align="center"><img id="to-ask-doctor"' +
            ' src="' + g_appRootPath + '/Public/img/hd/Home/V20/to_ask_doctor.png"' +
            ' alt="一键问医"/></td></tr>';
        G('record-container').innerHTML = htm;
    ...
    createButtons: function () {
        ...
        while (STATIC_TR--) {
            this.buttons.push({
                ...
                backgroundImage: g_appRootPath + '/Public/img/hd/Family/V20/btn_long.png',
                ...
                focusImage: g_appRootPath + '/Public/img/hd/Family/V20/btn_long_f.png'
            });
        }
        this.buttons.push({
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/Home/V20/to_ask_doctor.png',
            focusImage: g_appRootPath + '/Public/img/hd/Home/V20/to_ask_doctor_f.png',
            click: ''
        }, {
            id: 'btn-submit',
            name: '提交',
