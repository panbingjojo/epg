var Detail = {
    ...
    onBeforeMoveChangeScrollDistance: function (key, btn) {
        ...
        var changeDown = function () {
            Detail.Nc = Math.min(550, Detail.Nc += 20);
        };
    ...
    createBtns: function () {
        if (RenderParam.isArchived == 0) {
            G('archive').src = g_appRootPath + '/Public/img/hd/Family/V20/archive.png';
        } else {
            G('archive').src = g_appRootPath + '/Public/img/hd/Family/V20/inquiry_again.png';
        }
        this.buttons.push({
            id: 'archive',
            name: '归档/再次问诊',
            ...
            backgroundImage: RenderParam.isArchived == 0
                ? g_appRootPath + '/Public/img/hd/Family/V20/archive.png'
                : g_appRootPath + '/Public/img/hd/Family/V20/inquiry_again.png',
            focusImage: RenderParam.isArchived == 0
                ? g_appRootPath + '/Public/img/hd/Family/V20/archive_f.png'
                : g_appRootPath + '/Public/img/hd/Family/V20/inquiry_again_f.png',
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/Family/V20/delete.png',
            focusImage: g_appRootPath + '/Public/img/hd/Family/V20/delete_f.png',
    ...
    render: function (inquiryItem, inquiry39Obj) {
        ...
        // LMEPG.Inquiry.expertApi.createDoctorUrl(RenderParam.cwsHlwyyUrl, data.doc_id, data.avatar_url, RenderParam.carrierId);
    ...
    showDeleteDialog: function (btn) {
        LMEPG.UI.commonDialog.showV2('删除后不可恢复，您确定删除', ['确定', '取消'], function (btnId) {
            if (btnId == 0) {
                Detail.deleteInquiryRecord
            }
        });
    },
    ...
    clickArchiveOrInquiryAgain: function () {
        if (RenderParam.isArchived == 1) {
            // 再次问诊，该样式版本暂未使用，若需要使用该版本样式再开放功能
        } else {
            // 归档
