...
var Archive = {
    ...
    render: function () {
        ...
        this.currentData.forEach(function (t, i) {
            var image = g_appRootPath + '/Public/img/hd/Family/V20/icon_member_' + t.member_image_id + '.png';
            htm += '<div >' +
    ...
    createBtns: function () {
        ...
        while (FOCUS_COUNT--) {
            this.buttons.push({
                ...
                focusImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V13/ask_f.png' : g_appRootPath + '/Public/img/hd/Family/V20/ask_f.png',
