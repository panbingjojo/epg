...
var Home = {
    ...
    initButtons: function () {
        buttons.push({
            ...
            backgroundImage:g_appRootPath + "/Public/img/hd/Family/V10/bg_arching.png",
            focusImage:g_appRootPath + "/Public/img/hd/Family/V10/f_arching.png",
...
var Department = {
    ...
    prevPage: function () {
        if (Department.page > 0) {
            Department.page--;
            Department.createHtml(RenderParam.memberList.list);
            LMEPG.ButtonManager.requestFocus("card-3");
        } else {
            return false;
        }
    },
    ...
    nextPage: function () {
        if (Department.page < Math.ceil(RenderParam.memberList.list.length / Department.count) - 1) {
            Department.page++;
            Department.createHtml(RenderParam.memberList.list)
            LMEPG.ButtonManager.requestFocus("card-1");
        } else {
