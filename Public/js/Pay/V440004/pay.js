...
var page = {
    ...
    jumpDirectPay: function (payInfo) {
        ...
        console.log("json ::-->"+payInfoStr);
        var objDirectPay = LMEPG.Intent.createIntent('directPay');
        objDirectPay.setParam('orderParam', payInfoStr);
...
var Pay = {
    ...
    buildPayInfo: function (payInfo) {
        ...
        LMEPG.ajax.postAPI('Pay/buildPayUrl', payInfo, function (data) {
            ...
            console.log("[V440004 pay.js] --buildPayInfo->> data +"+JSON.stringify(data))
            if (data.result == 0) {
                //获取订购参数成功，跳转到直接订购界面
...
window.onload = function () {
    console.log("[V440004 pay.js]  --->>页面初始化")
    Pay.init();
};
