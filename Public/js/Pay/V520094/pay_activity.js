...
var Pay = {
    ...
    initButton: function () {
        buttons = [
            ...
            },
            {
                ...
                nextFocusUp: '',
                nextFocusDown: 'order',
                backgroundImage: g_appRootPath + '/Public/img/hd/Activity/ActivityDiscount/V1/bg_back.png',
                focusImage: g_appRootPath + '/Public/img/hd/Activity/ActivityDiscount/V1/f_back.png',
                click: onBack,
                focusChange: '',
                beforeMoveChange: '',
                moveChange: ''
                ...
                nextFocusUp: 'back',
                nextFocusDown: '',
                backgroundImage: g_appRootPath + '/Public/img/hd/Activity/ActivityDiscount/V1/bg_order.png',
                focusImage: g_appRootPath + '/Public/img/hd/Activity/ActivityDiscount/V1/f_order.png',
                click: Pay.onPayItemClick,
                focusChange: '',
                beforeMoveChange: '',
                moveChange: '',
    ...
    initBookPicture: function () {
        var imgPath = g_appRootPath + "/Public/img/hd/Pay/V520004/";
