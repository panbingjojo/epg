...
var Pay = {
    ...
    initPayItem: function () {
        buttons.push({
            ...
            backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V350092/back_btn.png',
            focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V350092/back_btn_f.png',
        ...
        buttons.push({
            ...
            nextFocusDown: '',
            backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V350092/sure_btn.png',
            focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V350092/sure_btn_f.png',
            click: Pay.onPayItemClick,
            focusChange: LMEPG.emptyFunc,
            beforeMoveChange: LMEPG.emptyFunc,
            moveChange: LMEPG.emptyFunc,
