...
function log(tag, msg, errorLevel) {
    if (errorLevel === true) console.error('[10220094][pay.js]--->[' + tag + ']--->' + msg);
    else console.info('[10220094][pay.js]--->[' + tag + ']--->' + msg);
    LMEPG.Log.info('[10220094][pay.js]--->[' + tag + ']--->' + msg);
}
                ...
                if (typeof window.top.jk39 !== 'undefined' && window.top.jk39 !== null && window.top.jk39.auth !== undefined) {
                    ...
                    window.top.jk39.auth({
                            ...
                            callback: function (result) {
                                log('JLPaySDK.doAuth()', '[doAuth][result]--->鉴权结果: ' + result+"套餐ID是:"+productId);
                                if (result == true) {
                                    //鉴权成功：已订购
                                    LMEPG.UI.dismissWaitingDialog();
                                    LMEPG.UI.showToast('已经订购过了'+productId);
                                } else {
                                    //鉴权失败：未订购
...
var Pay = {
    ...
    initButtons: function () {
        buttons.push({
            ...
            nextFocusUp: '',
            nextFocusDown: '',
            backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V10220094/payback0.png',
            focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V10220094/payback1.png',
            click: onBack,
            focusChange: '',
            beforeMoveChange: '',
            moveChange: '',
        ...
        buttons.push({
            ...
            nextFocusUp: '',
            nextFocusDown: '',
            backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V10220094/paymonth0.png',
            focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V10220094/paymonth1.png',
...
window.onerror = function (message, filename, lineno) {
    var errorLog = '[V210220094-pay.js]::error --->' + '\nmessage:' + message + '\nfile_name:' + filename + '\nline_NO:' + lineno;
    if (debug) {
