...
function jumpBuyVip(btn) {
    var PayInfo = {
        ...
        "product_id": RenderParam.productId,
...
var buttons = [
    {
        ...
        nextFocusUp: '',
        nextFocusDown: '',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V3/bg_pay_item_0.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V3/f_pay_item_0.png',
        click: onClick,
        ...
        nextFocusUp: '',
        nextFocusDown: '',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V3/bg_pay_item_1.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V3/f_pay_item_1.png',
        click: onClick,
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc,
        ...
        nextFocusDown: '',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/first_sure_btn.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/first_sure_btn_focus.png',
        click: onClick,
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc
        ...
        nextFocusDown: '',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/first_cancle_btn.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/first_cancle_btn_focus.png',
        click: onClick,
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc
        ...
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/verify_code_label.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/verify_code_label_focus.png',
        click: '',
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc
        ...
        nextFocusUp: '',
        nextFocusDown: 'second-sure',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/verify_code_clean.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/verify_code_clean_focus.png',
        click: onClick,
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc
...
function onBack() {
    ...
    if (judge == 'none') {
        ...
        G('content').innerHTML = '';
        Hide('second-model');
        LMEPG.ButtonManager.requestFocus('pay_item_0');
    }
}
    ...
    switch (btn.id) {
        ...
        case 'pay_item_1':
            if (RenderParam.isPayUnifyAuth == 1) {
                LMEPG.UI.commonDialog.show('确定订购39健康' + RenderParam.orderItems[btn.cIndex].price / 100 + '元/月产品吗?', ['确定', '取消'], function (index) {
                    if (index == 0) {
                        var PayInfo = {
...
// 弹出二次确认页
function jumpOrderToast(id) {
    Show('second-model');
    if (id == 'pay_item_0') {
        RenderParam.productId = 1;
        G('product_name').innerHTML = '<div id="product_name">' + RenderParam.payMessage.PRODUCT_NAME + '</div>'; // 产品名称
        G('product_order_type').innerHTML = '<div id="product_order_type">' + RenderParam.payMessage.PRODUCT_ORDER_TYPE + '</div>'; // 产品类型
        G('product_charge').innerHTML = '<div id="product_charge">' + RenderParam.payMessage.PRODUCT_CHARGE + '</div>'; // 资费信息
        G('product_charge_message').innerHTML = '<div id="product_charge_message">' + RenderParam.payMessage.PRODUCT_CHARGE_MESSAGE + '</div>'; // 资费说明
        G('query_order_cancel').innerHTML = '<div id="query_order_cancel">' + RenderParam.payMessage.QUERY_ORDER_CANCEL + '</div>'; // 查询及退订
    } else {
        RenderParam.productId = 2;
        G('product_name').innerHTML = '<div id="product_name">' + RenderParam.payMessage.PRODUCT_NAME + '</div>'; // 产品名称
        G('product_order_type').innerHTML = '<div id="product_order_type">' + RenderParam.payMessage.PRODUCT_ORDER_TYPE + '</div>'; // 产品类型
        G('product_charge').innerHTML = '<div id="product_charge">' + RenderParam.payMessage.PRODUCT_CHARGE_30DAY + '</div>'; // 资费信息
        G('product_charge_message').innerHTML = '<div id="product_charge_message">' + RenderParam.payMessage.PRODUCT_CHARGE_MESSAGE_30DAY + '</div>'; // 资费说明
        G('query_order_cancel').innerHTML = '<div id="query_order_cancel">' + RenderParam.payMessage.QUERY_ORDER_CANCEL + '</div>'; // 查询及退订
    }
    ...
    if (RenderParam.hasVerifyCode == 1) {
        ...
        G('content').innerHTML += '<img id="verify_code_label" src="__ROOT__/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/verify_code_label.png" />';
        G('content').innerHTML += '<img id="verify_code_clean" src="__ROOT__/Public/img/' + RenderParam.platformType + '/Pay/V000051/V2/verify_code_clean.png" />';
        ...
        // 根据参数来判断默认焦点的位置
        if (RenderParam.payFocusPosition == 1) {
