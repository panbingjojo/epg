...
var buttons = [
    {
        ...
        nextFocusUp: '',
        nextFocusDown: '',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/first_sure_btn.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/first_sure_btn_focus.png',
        click: onClick,
        ...
        nextFocusUp: '',
        nextFocusDown: '',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/first_cancle_btn.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/first_cancle_btn_focus.png',
        click: onClick,
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc
        ...
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/verify_code_label.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/verify_code_label_focus.png',
        click: '',
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc
        ...
        nextFocusUp: '',
        nextFocusDown: 'second-sure',
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/verify_code_clean.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V000051/V6/verify_code_clean_focus.png',
        click: onClick,
        focusChange: LMEPG.emptyFunc,
        beforeMoveChange: LMEPG.emptyFunc,
        moveChange: LMEPG.emptyFunc
...
function jumpOrderToast() {
    ...
    // 根据参数来判断默认焦点的位置
    if (RenderParam.payFocusPosition == 0) {
        LMEPG.ButtonManager.requestFocus('second-sure');
    } else if (RenderParam.payFocusPosition == 1) {
        LMEPG.ButtonManager.requestFocus('second-cancle');
    } else if (RenderParam.payFocusPosition == 2) {
