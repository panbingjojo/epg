...
var Pay = {
        ...
        buttons.push(
            {
                ...
                nextFocusUp: '',
                nextFocusDown: '',
                backgroundImage: ROOT + '/Public/img/Pay/V440004/btn_ok_one_out.png',
                focusImage: ROOT + '/Public/img/Pay/V440004/btn_ok_one_in.png',
        ...
        buttons.push(
            {
                ...
                nextFocusUp: '',
                nextFocusDown: '',
                backgroundImage: ROOT + '/Public/img/Pay/V440004/btn_cancle_one_out.png',
                focusImage: ROOT + '/Public/img/Pay/V440004/btn_cancle_one_in.png',
                click: 'onBack()',
                focusChange: '',
                beforeMoveChange: '',
                moveChange:  '',
    ...
    showBuyDialogOne:function () {
        var _html = "";
        _html += '<div ><img id="default_focus" src="'+ ROOT +'/Public/img/Pay/V440004/bg.png"/>';//背景图
        _html += '<div id="btn-text-one">海量视频随心看，仅需'+ (RenderParam.orderItems[0].price/100) +'元/月。<br/>是否确认订购?<br/></div>';
        _html += '<img id="btn-ok-one" src="'+ ROOT +'/Public/img/Pay/V440004/btn_ok_one_out.png"/>';
        _html += '<img id="btn-cancle-one" src="' + ROOT + '/Public/img/Pay/V440004/btn_cancle_one_out.png"/>';
