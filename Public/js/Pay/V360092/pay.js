...
var Pay = {
    ...
    initPayItem: function () {
        buttons.push({
            ...
            backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V360092/bg_back.png',
            focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V360092/f_back.png',
        ...
        buttons.push({
            ...
            nextFocusUp: 'back',
            nextFocusDown: '',
            backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V360092/bg_pay_item_0.png',
            focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V360092/f_pay_item_0.png',
            click: Pay.onPayItemClick,
            focusChange: LMEPG.emptyFunc,
            beforeMoveChange: LMEPG.emptyFunc,
            moveChange: LMEPG.emptyFunc,
        ...
        buttons.push({
            ...
            nextFocusUp: 'back',
            nextFocusDown: '',
            backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V360092/bg_pay_item_1.png',
            focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Pay/V360092/f_pay_item_1.png',
            click: Pay.onPayItemClick,
            focusChange: LMEPG.emptyFunc,
            beforeMoveChange: LMEPG.emptyFunc,
            moveChange: LMEPG.emptyFunc,
