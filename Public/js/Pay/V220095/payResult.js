...
function log(tag, msg, errorLevel) {
    if (errorLevel === true) console.error('[220094][payResult.html]--->[' + tag + ']--->' + msg);
    else console.log('[220094][payResult.html]--->[' + tag + ']--->' + msg);
    LMEPG.Log.info('[220094][payResult.html]--->[' + tag + ']--->' + msg);
}
...
window.onerror = function (message, filename, lineno) {
    var errorLog = '[V2220094-payResult.js]::error --->' + '\nmessage:' + message + '\nfile_name:' + filename + '\nline_NO:' + lineno;
