...
var Channel = {
    ...
    initRecommendPosition: function () {
        ...
        buttons.push({
            ...
            backgroundImage: g_appRootPath + "/Public/img/hd/Channel/V20/bg_un_collect.png",
            focusImage: g_appRootPath + "/Public/img/hd/Channel/V20/f_un_collect.png",
            cBackgroundImage: g_appRootPath + "/Public/img/hd/Channel/V20/bg_collect.png",
            cFocusImage: g_appRootPath + "/Public/img/hd/Channel/V20/f_collect.png",
            uBackgroundImage: g_appRootPath + "/Public/img/hd/Channel/V20/bg_un_collect.png",
            uFocusImage: g_appRootPath + "/Public/img/hd/Channel/V20/f_un_collect.png",
...
var List = {
    ...
    createList: function (page) {
        ...
        // 分页
        pageNum = Math.ceil(videoList.length / (cutNum * cutNum));
        ...
        for (var i = 0; i < newArr.length; i++) {
            ...
            strTable += '<div  class="recommended_title2">' + videoNum + '</div> ';
            strTable += '</div></div>';
        }
    ...
    preMenu: function () {
        if (pageCurrent > 1) {
            ...
            // LMEPG.ButtonManager.requestFocus("pagination-8");
            LMEPG.BM._buttons = {};
    ...
    nextMenu: function () {
        if (pageCurrent < pageNum) {
            ...
            LMEPG.BM._buttons = {};
            LMEPG.ButtonManager.init("pagination-1", buttons, "", true);
        } else {
    ...
    createPagination: function (data) {
        ...
        for (var i = 0; i < navList.length; i++) {
            ...
            buttons.push({
                ...
                focusImage: g_appRootPath + "/Public/img/hd/Channel/V20/f_btn_1.png",
                selectedImage: g_appRootPath + "/Public/img/hd/Channel/V20/select_btn_1.png",
                click: "",
