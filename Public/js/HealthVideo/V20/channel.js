...
var Channel = {
    ...
    initRecommendPosition: function () {
        ...
        buttons.push({
            ...
            backgroundImage: g_appRootPath + "/Public/img/hd/Channel/V20/bg_search.png",
            focusImage: g_appRootPath + "/Public/img/hd/Channel/V20/f_search.png",
            selectedImage: g_appRootPath + "/Public/img/hd/Channel/V20/select_search.png",
