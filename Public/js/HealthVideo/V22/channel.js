    ...
    initRecommendPosition: function () {
        for (var i = 0; i < cutNum; i++) {
            ...
            buttons.push({
                ...
                nextFocusUp: i < 4 ? 'btn_search' : 'recommended_' + upBtn,
                nextFocusDown: i < 4 ?  'recommended_' + downBtn : '',
                backgroundImage: "",
                focusImage: "",
                ...
                switch (current.id) {
                    ...
                    case 'recommended_8':
                        ...
                        if (!LMEPG.Func.isEmpty(nextFocusDownId)) {
                            ...
                            if (current.id == 'recommended_3' || current.id == 'recommended_6') {
                            ...
                            } else if (current.id == 'recommended_4' || current.id == 'recommended_7') {
                                nextRightBtn = LMEPG.BM.getButtonById(current.nextFocusRight);
                                if (!LMEPG.Func.isEmpty(nextRightBtn))
...
var List = {
    ...
    preMenu: function () {
        if (pageCurrent > 1) {
            ...
            LMEPG.ButtonManager.requestFocus("recommended_4");
        }
    },
