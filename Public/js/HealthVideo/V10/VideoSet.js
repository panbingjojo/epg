...
var Channel = {
    ...
    initRecommendPosition: function () {
        ...
        buttons.push({
            ...
            backgroundImage: g_appRootPath + "/Public/img/hd/Home/V10/bg_un_collect.png",
            focusImage: g_appRootPath + "/Public/img/hd/Home/V10/f_un_collect.png",
            cBackgroundImage: g_appRootPath + "/Public/img/hd/Home/V10/bg_collect.png",
            cFocusImage: g_appRootPath + "/Public/img/hd/Home/V10/f_collect.png",
            uBackgroundImage: g_appRootPath + "/Public/img/hd/Home/V10/bg_un_collect.png",
            uFocusImage: g_appRootPath + "/Public/img/hd/Home/V10/f_un_collect.png",
