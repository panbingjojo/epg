...
var LMMediaPlayer = {
    ...
    init: function () {
        try{
            ...
            LMEPG.Log.info("task::MediaPlayer：" + e.toString());
        }
    ...
    play: function (mediaUrl) {
        ...
        debug2(mediaUrl);
        var mediaStr = LMMediaPlayer.formatMediaStr(mediaUrl);
...
var DetainPage = {
    ...
    initButtons: function () {
        DetainPage.buttons.push({
            ...
            nextFocusRight: 'back',
            backgroundImage: g_appRootPath + '/Public/img/hd/Player/V22/btn_collect.png',
            focusImage: g_appRootPath + '/Public/img/hd/Player/V22/btn_collect_f.png',
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/Player/V22/btn_replay.png',
            focusImage: g_appRootPath + '/Public/img/hd/Player/V22/btn_replay_f.png',
            click: DetainPage.eventHandler,
            focusChange: '',
            beforeMoveChange: ''
        }, {
            ...
            nextFocusRight: '',
            backgroundImage: g_appRootPath+ '/Public/img/hd/Player/V22/btn_back.png',
            focusImage: g_appRootPath+ '/Public/img/hd/Player/V22/btn_back_f.png',
            click: DetainPage.eventHandler,
            focusChange: '',
            beforeMoveChange: ''
        }, {
            ...
            //focusImage: RenderParam.platformType == 'sd' ? '/Public/img/sd/Unclassified/V13/video_f.png' : g_appRootPath + '/Public/img/hd/Player/V13/video_f.png',
            click: DetainPage.eventHandler,
    ...
    toggleMarquee: function (btn,hasFocus){
        var id = 'recommend-img-'+btn.id.split('-')[1];
        if (hasFocus) {
            G(id).style.cssText = "border:5px solid #fff;border-radius:15px;margin-top: -4px;";
            if (btn.id.split('-')[1]== '1'){
                G(id).style.cssText = G(id).style.cssText+"margin-left: -1px;";
            }
        }else{
            G(id).style.cssText = "border:0px solid #fff;border-radius:0px;margin-top: 0px;";
            if (btn.id.split('-')[1]== '1'){
                G(id).style.cssText = G(id).style.cssText+"margin-left: 0px;";
            }
        }
    },
    ...
    playVideo: function (btn) {
        ...
        if (DetainPage.allowPlayVideo(videoInfo)) {
            // 直接播放推荐视频
            try{
                PlayrPage.jumpPlayVideo(videoInfo);
            }catch (e) {
                LMEPG.Log.info("task::jumpPlayVideo：" + e.toString());
            }
        } else {
    ...
    checkUserOrderStatus: function (videoInfo) {
        if (RenderParam.isForbidOrder == '1') { // 如果isForbidOrder = 1，表示不允许订购，直接返回
            ...
            PlayrPage.jumpBuyVip(videoInfo.title, videoInfo);
        }
    },
