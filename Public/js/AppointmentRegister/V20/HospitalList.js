var Hosp = {
    ...
    beforeMoveItem: function (key, btn) {
        ...
        if (key == 'up' && (btn.id == 'focus-0' || btn.id == 'focus-2'|| btn.id == 'focus-3')) {
    ...
    clickItem: function (btn) {
        ...
        if (Hosp.page == Hosp.maxPage && cutLen == Hosp.cutDataLength - 1) {
    ...
    createButtons: function () {
        ...
        while (Nc--) {
            this.buttons.push({
                ...
                focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/HistoryPlay/V20/video_list_f.png',
