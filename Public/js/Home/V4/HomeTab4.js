...
var Home = {
    ...
    onRecommendFocusChange: function (btn, hasFocus) {
        ...
        if (hasFocus) {
            ...
            if (RenderParam.platformType == 'hd') { // 高清放大处理，标清不放大
                LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_zoom_in');
                if (btn.id === 'recommend_border_1') {
                    LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_zoom_out_1');
                } else {
                ...
                switch (btn.cPosition) {
                    ...
                    case '52':
                        ...
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.UI.setCorner(G('recommend_2').parentElement, 366, 152, 50, 50, isShowCorner, 'recommend_2_corner', 3);
                        break;
                    case '53':
                        Show('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.UI.setCorner(G('recommend_3').parentElement, 903, 147, 50, 50, isShowCorner, 'recommend_3_corner', 3);
                        break;
                    case '54':
                        Show('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.UI.setCorner(G('recommend_4').parentElement, 370, 424, 50, 50, isShowCorner, 'recommend_4_corner', 3);
                        break;
                    case '55':
                        Show('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.UI.setCorner(G('recommend_5').parentElement, 578, 423, 50, 50, isShowCorner, 'recommend_5_corner', 3);
                        break;
                    case '56':
                        Show('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.UI.setCorner(G('recommend_6').parentElement, 786, 423, 50, 50, isShowCorner, 'recommend_6_corner', 3);
                        break;
                    case '57':
                        Show('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.UI.setCorner(G('recommend_7').parentElement, 1004, 423, 50, 50, isShowCorner, 'recommend_7_corner', 3);
                        break;
                }
            ...
            if (RenderParam.platformType == 'hd') {
                ...
                switch (btn.cPosition) {
                    ...
                    case '52':
                        ...
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.UI.setCorner(G('recommend_2').parentElement, 370, 152, 50, 50, isShowCorner, 'recommend_2_corner', 1);
                        break;
                    case '53':
                        Hide('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.UI.setCorner(G('recommend_3').parentElement, 906, 152, 50, 50, isShowCorner, 'recommend_3_corner', 1);
                        break;
                    case '54':
                        Hide('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.UI.setCorner(G('recommend_4').parentElement, 370, 424, 50, 50, isShowCorner, 'recommend_4_corner', 1);
                        break;
                    case '55':
                        Hide('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.UI.setCorner(G('recommend_5').parentElement, 582, 424, 50, 50, isShowCorner, 'recommend_5_corner', 1);
                        break;
                    case '56':
                        Hide('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.UI.setCorner(G('recommend_6').parentElement, 790, 424, 50, 50, isShowCorner, 'recommend_6_corner', 1);
                        break;
                    case '57':
                        Hide('recommend_border_' + btn.cIdx);
                        LMEPG.CssManager.removeClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx + '_zoom_in');
                        LMEPG.CssManager.addClass(G('recommend_' + btn.cIdx), 'recommend_' + btn.cIdx);
                        LMEPG.UI.setCorner(G('recommend_7').parentElement, 1005, 424, 50, 50, isShowCorner, 'recommend_7_corner', 1);
                        break;
                }
            }
        }
            ...
            switch (data.position) {
                ...
                case '55': // 第五个位置
                    if (RenderParam.platformType == 'hd') {
                        ...
                        LMEPG.UI.setCorner(G('recommend_5').parentElement, 293, 281, 30, 30, isShowCorner, 'recommend_5_corner', 1);
                    }
                ...
                case '56': // 第六个位置
                    if (RenderParam.platformType == 'hd') {
                        ...
                        LMEPG.UI.setCorner(G('recommend_6').parentElement, 406, 281, 30, 30, isShowCorner, 'recommend_6_corner', 1);
                    }
                ...
                case '57': // 第七个位置
                    if (RenderParam.platformType == 'hd') {
                        ...
                        LMEPG.UI.setCorner(G('recommend_7').parentElement, 519, 281, 30, 30, isShowCorner, 'recommend_7_corner', 1);
                    }
                    G('recommend_7').src = RenderParam.fsUrl + data.image_url;
                    Home.showCornerPay('recommend_parent_7', 7, data);
                    break;
            }
        }
    },
