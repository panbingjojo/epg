...
var Page = {
     ...
     * 跳转 - 专家约诊记录
     */
    jumpExpertRecordHome: function (id) {
        var objCurrent = Page.getCurrentPage();
        var objExpertRecord = {};
     ...
     *  跳转 - 调用apk的专家约诊记录
     */
    jumpExpertRecordBridge: function (id, appointmentId) {
        var objCurrent = Page.getCurrentPage();
...
var Home = {
    ...
    onMenuBeforMoveChange: function (dir, current) {
        if (dir == 'up') {
            ...
            Page.jumpHomeTab('homeTab3', 'recommend_border_5');
            return false;
        }
    },
    ...
    onMenuClick: function (btn) {
        switch (btn.id) {
            case 'menu_border_0':
                // 成为会员
                Page.jumpBuyVipWithNormal('MenuTab4');
                break;
            case 'menu_border_1':
        ...
        if (dir == 'up') {
            ...
            switch (current.id) {
                ...
                case 'recommend_border_7':
                    Page.jumpHomeTab('home', 'recommend_border_1');
                    return false;
            }
        }
    },
