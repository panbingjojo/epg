...
var Page = {
    ...
    getCurrentPage: function () {
        var objCurrent = LMEPG.Intent.createIntent('homeTab1');
     ...
     * @param id 焦点ID
     */
    jumpInquiryDoctorList: function (id) {
        var objDoctorP2P = {};
        var objHome = Page.getCurrentPage();
...
var Home = {
    ...
    onMenuBeforMoveChange: function (dir, current) {
        if (dir == 'up') {
            ...
            Page.jumpHomeTab('home', 'recommend_border_3');
            return false;
        }
    },
    ...
    onMenuClick: function (btn) {
        switch (btn.id) {
            case 'menu_border_0':
                ...
                Page.jumpBuyVipWithNormal('MenuTab1');
                break;
            case 'menu_border_1':
        ...
        if (dir == 'up') {
            ...
            switch (current.id) {
                ...
                case 'recommend_border_6':
                    Page.jumpHomeTab('homeTab2', 'recommend_border_1');
                    return false;
            }
        }
    },
