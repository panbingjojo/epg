...
function renderPage() {
    ...
    var htm = '';
    var renderData = data.slice(count, count + 2);
    renderData.forEach(function (item, index) {

        htm += '<div id=focus-' + (index + 1) + '>';
        htm += '<div class="medicine-house-wrapper">';
        htm += '<img class="house-bg" src="__ROOT__/Public/img/hd/Menu/QHotherPages/medicineHouse.png" alt="">';
    ...
    toggleArrow();
    G('page-index').innerText = (count + 1) + '/' + data.length;
}
