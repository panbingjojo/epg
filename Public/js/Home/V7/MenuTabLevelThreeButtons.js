...
var JumpPage = {
    ...
    getRecommendDataByPosition: function (position) {
        ...
        if (tmpData != '') {
            ...
            data.durationTime = tmpData.duration;
        }
 ...
 * 获取到当前三级页面导航图片
 */
var currentThirdTabNavImgs = MenuTabDataSource.getThirdTabNavImgs()[RenderParam.homeTabIndex];
...
var buttons = [{
    ...
    focusImage: g_appRootPath + '/Public/img/hd/Menu/Common/search_f.png',
    ...
    focusImage: g_appRootPath + '/Public/img/hd/Menu/Common/collection_f.png',
     ...
     */
    {
        ...
        backgroundImage: currentThirdTabNavImgs[0].normal,
        focusImage: currentThirdTabNavImgs[0].focused,
        selectedImage: currentThirdTabNavImgs[0].selected,
        ...
        nextFocusUp: 'search',
        nextFocusDown: 'video-link-0',
        backgroundImage: currentThirdTabNavImgs[1].normal,
        focusImage: currentThirdTabNavImgs[1].focused,
        selectedImage: currentThirdTabNavImgs[1].selected,
        click: clickSelectedFocus,
        focusChange: judgeSelectedFocus,
        beforeMoveChange: '',
        moveChange: '',
        ...
        nextFocusUp: 'search',
        nextFocusDown: 'video-link-0',
        backgroundImage: currentThirdTabNavImgs[2].normal,
        focusImage: currentThirdTabNavImgs[2].focused,
        selectedImage: currentThirdTabNavImgs[3].selected,
        click: clickSelectedFocus,
        focusChange: judgeSelectedFocus,
        beforeMoveChange: '',
        moveChange: '',
        ...
        nextFocusUp: 'search',
        nextFocusDown: 'video-link-0',
        backgroundImage: currentThirdTabNavImgs[3].normal,
        focusImage: currentThirdTabNavImgs[3].focused,
        selectedImage: currentThirdTabNavImgs[3].selected,
        click: clickSelectedFocus,
        focusChange: judgeSelectedFocus,
        beforeMoveChange: '',
...
function clickSelectedFocus(btn) {
    ...
    for (var i = 0; i < currentIdChildList.length; i++) {
        currentIdChildList[i].src = currentThirdTabNavImgs[i].normal;
    }
...
function judgeSelectedFocus(btn, focus) {
    if (focus) {
        ...
        G('nav-' + currentTab).src = currentThirdTabNavImgs[currentTab].selected;
    }
}
