...
var renderTabsPage = {
    ...
    configurableHtml: function () {
        ...
        var renderThemeUI = function () {
            var themeImage = 'url(__ROOT__/Public/img/hd/Menu/Common/bg.png)'; // 默认背景
        ...
        this.carouselHtml = function () {
            ...
            htm += '<img id=\'arrow-prev\' src=\'' + g_appRootPath + '/Public/img/hd/Menu/Common/prev.png\'>';
            ...
            htm += '<img id=\'arrow-next\' src=\'' + g_appRootPath + '/Public/img/hd/Menu/Common/next.png\'>';
            htm += '<ul id=\'point\'>';
            htm += '<li id=\'point-1\'>';
            htm += '<li>';
