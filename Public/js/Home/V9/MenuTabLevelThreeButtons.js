...
var buttons = [{
     ...
     */
    {
        ...
        backgroundImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav0.png',
        focusImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav0_f.png',
        selectedImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav0_s.png',
        ...
        nextFocusUp: 'search',
        nextFocusDown: 'video-link-0',
        backgroundImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav1.png',
        focusImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav1_f.png',
        selectedImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav1_s.png',
        click: clickSelectedFocus,
        focusChange: judgeSelectedFocus,
        beforeMoveChange: '',
        moveChange: '',
        ...
        nextFocusUp: 'search',
        nextFocusDown: 'video-link-0',
        backgroundImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav2.png',
        focusImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav2_f.png',
        selectedImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav2_s.png',
        click: clickSelectedFocus,
        focusChange: judgeSelectedFocus,
        beforeMoveChange: '',
        moveChange: '',
        ...
        nextFocusUp: 'search',
        nextFocusDown: 'video-link-0',
        backgroundImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav3.png',
        focusImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav3_f.png',
        selectedImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav3_s.png',
        click: clickSelectedFocus,
        focusChange: judgeSelectedFocus,
        beforeMoveChange: '',
        moveChange: '',
     ...
     */
    {
        ...
        focusImage: g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/levelThree_f.png',
...
function clickSelectedFocus(btn) {
    ...
    for (var i = 0; i < currentIdChildList.length; i++) {
        currentIdChildList[i].src = g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav' + i + '.png';
    }
...
function judgeSelectedFocus(btn, focus) {
    if (focus) {
        ...
        G('nav-' + currentTab).src = g_appRootPath + '/Public/img/hd/Menu/Tab' + RenderParam.homeTabIndex + '/nav' + currentTab + '_s.png';
    }
}
