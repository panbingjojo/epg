...
var buttons = [
    {
        ...
        nextFocusRight: '',
        nextFocusDown: 'home',
        backgroundImage: RenderParam.fileIndex + 'pay_btn.png',
        focusImage: RenderParam.fileIndex + 'pay_btn_f.png',
        focusChange: onFocus,
        click: keyDownEnter
    }];
...
function getCurrentPage(_thisfocus) {
    var objCurrent = LMEPG.Intent.createIntent('introVideo-single');
