var LMAlbum = {
    ...
    isRecommendRouteHome: false, // 是否V13模式，推荐位跳转【精选专题模块】
    ...
    initRegional: function (albumAlias) {
        ...
        var recommendRouteHomeCarriers = ['000709', '410092', '420092', '430002', '440001', '450092','371002','371092','650092','220001','640001','000005','150002','370092','430012','450004','01230001','450001', '450094'];
        if (recommendRouteHomeCarriers.indexOf(RenderParam.lmcid) > -1) {
            LMAlbum.viewMorePageName = 'home';
            LMAlbum.classifyId = 0;
            LMAlbum.isRecommendRouteHome = true;
        }
    ...
    goBack: function () {
        ...
        if (LMAlbum.dialogId) {
            ...
            if (RenderParam.lmcid == '370092' || RenderParam.lmcid == '500092' || RenderParam.lmcid == '000051' || RenderParam.lmcid == '640094' || RenderParam.lmcid == '420092') {
                LMAlbum.commonBack();
            } else {
                LMAlbum.commonBack();
            }
    ...
    onClickViewMoreListener: function (btn) {
        ...
        if (LMAlbum.isRecommendRouteHome) {
