...
var Mark = {
    ...
    init: function () {
        var that = this
        this.getSkinList(function (list) {
            document.body.style.backgroundImage = 'url('+RenderParam.fsUrl+list[1].list_img_url+')'
            that.createBtns();
            that.createDate();
            that.initInfo(arg.markInfo);
        })
                ...
                try {
                    ...
                    if (data.result == 0) {
                        ...
                        modal.textDialog({
                            beClickBtnId: btn.id,
                            time: 2
                        }, "", "", "签到成功，获得积分+"+data.today_in_score, "");

                        G('modal').style.backgroundImage = 'url(/Public/img/hd/DateMark/pop-bg.png)'
                        document.getElementsByClassName('modal_center_img')[0].style.display = 'none'
                        document.getElementsByClassName('msg_text')[0].style.color = '#fff'

                    } else {
                        LMEPG.UI.showToast('签到失败!请检查盒子时间是否为今日', 3);
                    }
                } catch (e) {
    ...
    createBtns: function () {
        this.buttons.push({
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/DateMark/btn_rules.png',
            focusImage: g_appRootPath + '/Public/img/hd/DateMark/btn_rules_f.png',
            click: this.onClick
        }, {
            id: 'btn-lottery',
            name: '抽奖',
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/DateMark/btn_lottery.png',
            focusImage: g_appRootPath + '/Public/img/hd/DateMark/btn_lottery_f.png',
            focusChange: '',
            click: this.onClick
        }, {
            id: 'btn-mark',
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/DateMark/btn_mark.png',
            focusImage: g_appRootPath + '/Public/img/hd/DateMark/btn_mark_f.png',
            hadMarkImage: g_appRootPath + '/Public/img/hd/DateMark/btn_mark_s.png',
            click: this.onClick,
            focusable: true
        }, {
            id: 'debug',
