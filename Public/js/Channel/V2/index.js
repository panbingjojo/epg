                ...
                case DATA_TYPE_VIDEO:
                    ...
                    try {
                        ...
                        var videoInfo = {
                            ...
                            "entryType": 3,
                            "entryTypeName": RenderParam.modeType,
...
var buttons = [
    {
        ...
        nextFocusDown: '',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V2/transparent.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V2/imgbox.png",
        click: onKeyEnter,
...
function createElements(list) {
    ...
    var borderGetUrl = g_appRootPath + "/Public/img/Channel/V2/imgbox.png";
    var borderLostUrl = g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V2/transparent.png";  //失去焦点背景边框
