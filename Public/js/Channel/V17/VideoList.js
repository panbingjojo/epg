...
var Level3 = {
	...
	init: function () {
		...
		Level3.keepFocusId && this.bg(Level3.keepFocusId, RenderParam.platformType=='sd'?g_appRootPath+'/Public/img/sd/Unclassified/V16/gather_video_s.png':g_appRootPath+'/Public/img/hd/Channel/V16/gather_video_s.png');
	},
	...
	initListFocusBtn: function (pageData) {
		...
		// var sdImg = '/Public/img/sd/Unclassified/V16/video_list1_f.png';
		var sdImg =g_appRootPath+  '/Public/img/hd/Channel/V16/video_list_f.png';
		var hdImg = g_appRootPath+ '/Public/img/hd/Channel/V16/video_list_f.png';
		while (listLen--) {
			this.buttons.push({
				id: 'focus-' + listLen,
				name: '',
	...
	setNavBgState: function (dir) {
		...
		me.bg(me.keepFocusId, RenderParam.platformType=='sd'?g_appRootPath+'/Public/img/sd/Unclassified/V16/gather_video.png':g_appRootPath+'/Public/img/hd/Channel/V16/gather_video.png');
		me.keepFocusId = 'tab-' + (tabFocusIndex - (dir === "left" ? (tabFocusIndex === 0 ? 0 : 1) : (tabFocusIndex === 6 ? 6 : -1)));
		me.bg(me.keepFocusId, RenderParam.platformType=='sd'?g_appRootPath+'/Public/img/sd/Unclassified/V16/gather_video_s.png':g_appRootPath+'/Public/img/hd/Channel/V16/gather_video_s.png');
	},
	...
	createBtns: function () {
		this.buttons.push({
			...
			nextFocusDown: 'debug',
			backgroundImage: g_appRootPath+'/Public/img/hd/Channel/V16/collect.png',
			focusImage: g_appRootPath+'/Public/img/hd/Channel/V16/collect_f.png',
			...
			nextFocusDown: 'debug',
			backgroundImage: g_appRootPath+'/Public/img/hd/Channel/V16/one_key_inquiry.png',
			focusImage:g_appRootPath+ '/Public/img/hd/Channel/V16/one_key_inquiry_f.png',
			click: '',
			beforeMoveChange: this.onFocusMoveToNavFocusId,
			focusChange: ''
		}, {
		...
		while (tabLen--) {
			this.buttons.push({
				...
				backgroundImage:  RenderParam.platformType=='sd'?g_appRootPath+ '/Public/img/sd/Unclassified/V16/gather_video.png':g_appRootPath+ '/Public/img/hd/Channel/V16/gather_video.png',
				focusImage: RenderParam.platformType=='sd'?g_appRootPath+ '/Public/img/sd/Unclassified/V16/gather_video_f.png':g_appRootPath+ '/Public/img/hd/Channel/V16/gather_video_f.png',
				selectedImage: RenderParam.platformType=='sd'?g_appRootPath+ '/Public/img/sd/Unclassified/V16/gather_video_s.png': g_appRootPath+ '/Public/img/hd/Channel/V16/gather_video_s.png',
				click: '',
			...
			try {
				...
				if (collectItem.result == 0) {
					if (postData.type == 0) {
						...
						G("collect").src =  g_appRootPath+"/Public/img/hd/Channel/V16/collected_f.png";
						LMEPG.UI.showToast("收藏成功");
					} else {
						//取消收藏成功
						RenderParam.isCollect = 0;
						G("collect").src =  g_appRootPath+ g_appRootPath+"/Public/img/hd/Channel/V16/collect_f.png";
	...
	updateCollectBtnUI: function () {
		...
		if (RenderParam.isCollect == 0) {
			collectBtn.backgroundImage =  g_appRootPath+"/Public/img/hd/Channel/V16/collect.png";
			collectBtn.focusImage = g_appRootPath+ "/Public/img/hd/Channel/V16/collect_f.png";
			if (currentFocusBtn != 'collect')
				G("collect").src = g_appRootPath+ "/Public/img/hd/Channel/V16/collect.png";
		} else {
			collectBtn.backgroundImage =  g_appRootPath+"/Public/img/hd/Channel/V16/collected.png";
			collectBtn.focusImage = g_appRootPath+ "/Public/img/hd/Channel/V16/collected_f.png";
			if (currentFocusBtn != 'collect')
				G("collect").src =  g_appRootPath+"/Public/img/hd/Channel/V16/collected.png";
		}
	},
};
