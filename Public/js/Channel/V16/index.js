	...
	init: function() {
		...
		Level2.getVideoSetList(RenderParam.secondClass.data[Level2.navIndex + Level2.navPage * 5].model_type, Level2.navIndex, function() {
			...
			if (!LMEPG.Func.isEmpty(RenderParam.focusId)) {
				...
				G(Level2.keepNavFocusId).style.backgroundImage = 'url(' + '__ROOT__/Public/img/hd/Channel/V16/btn_nav_s.png)';
	...
	createBtns: function() {
		...
		while (count--) {
			this.buttons.push({
				...
				// focusImage: RenderParam.platformType=='sd'?'/Public/img/sd/Unclassified/V13/nav_f.png': g_appRootPath + '/Public/img/hd/Channel/V16/btn_nav_f.png',
				// selectedImage:RenderParam.platformType=='sd'?'/Public/img/sd/Unclassified/V13/nav_s.png':  '/Public/img/hd/Channel/V16/btn_nav_s.png',
				focusImage:  g_appRootPath+ '/Public/img/hd/Channel/V16/btn_nav_f.png',
		...
		while (VIDEO_COUNT--) {
			this.buttons.push({
				...
				backgroundImage: g_appRootPath+ '/Public/img/hd/Common/transparent.png',
				// focusImage: RenderParam.platformType == 'sd' ? '/Public/img/sd/Unclassified/V13/video_f.png' : g_appRootPath + '/Public/img/hd/Channel/V16/video_f.png',
				focusImage:  g_appRootPath+ '/Public/img/hd/Channel/V16/video_f.png',
