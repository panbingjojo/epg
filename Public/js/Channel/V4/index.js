...
var Page = {
    ...
    jumpBuyVip: function (id, remark) {
        ...
        var packetType = RenderParam.modeType == '1'? 1:2;      // packetType 小包订购类型 1：宝贝天地 2：中老年健康 3：健康自测
        var objOrderHome = LMEPG.Intent.createIntent("orderHome");
        objOrderHome.setParam("isPlaying", "1");
        objOrderHome.setParam("remark", remark);
        RenderParam.carrierId == '370092' ? objOrderHome.setParam("packetType", packetType):'';
    ...
    jumpPlayVideo: function (videoInfo) {
        ...
        objPlayer.setParam("modelType", RenderParam.modeType);
...
var dataSet = (function () {
    return {
        ...
        init: function (rawData) {
            ...
            if(RenderParam.carrierId =='370092' && RenderParam.isVip == '0'){
                //山东电信 大包非VIP 进行小包鉴权 56:中老年健康 57：宝贝天地
                var packetType = RenderParam.modeType == '56' ? '2':'1';
                var postData ={
                    'packetType': packetType,
                };
                LMEPG.ajax.postAPI("Pay/authPacketType", postData, function (data) {
                    console.log(data);
                    if (data.resultCode == 0) {
                        RenderParam.isPacketVip = '1' ;
                    } else {
                        RenderParam.isPacketVip = '0';
                    }
                })
            }
...
function createElements(list) {
    ...
    for (var dataIndex = 0; dataIndex < list.length; dataIndex++) {
        ...
        LMEPG.UI.setCornerMore(uiParent, 0, 0, 40, 40, userType, videoItem.user_type,uiParentID+'-icon');
        /*switch (uiParentID) {
            case "focus-1-1":
                if (platformType == "hd") {
                    LMEPG.UI.setCornerMore(uiParent, 0, 0, 40, 40, userType, videoItem.user_type,uiParentID+'-icon');
            ...
            case "focus-1-2":
                if (platformType == "hd") {
                    LMEPG.UI.setCornerMore(uiParent, 0, 0, 40, 40, userType, videoItem.user_type);
                } else {
 ...
 */
function getData() {
    var postData = {"page": pageCurrent, "userId": RenderParam.userId, "modeType": RenderParam.modeType, "pageNum": 10};
...
var buttons = [
    {
        ...
        nextFocusUp: '',
        nextFocusDown: 'focus-2-1-border',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/transparent.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/imgbox.png",
        click: onKeyEnter,
    ...
    },
    {
        ...
        nextFocusUp: '',
        nextFocusDown: 'focus-2-2-border',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/transparent.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/imgbox.png",
        click: onKeyEnter,
    ...
    },
    {
        ...
        nextFocusUp: '',
        nextFocusDown: 'focus-2-3-border',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/transparent.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/imgbox.png",
        click: onKeyEnter,
    ...
    },
    {
        ...
        nextFocusRight: 'focus-1-5-border',
        nextFocusUp: '',
        nextFocusDown: 'focus-2-4-border',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/transparent.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/imgbox.png",
        click: onKeyEnter,
    ...
    },
    {
        ...
        type: 'img',
        indexId: 'focus-1-5',
        title: 'focus-1-5-title',
        nextFocusLeft: 'focus-1-4-border',
        nextFocusRight: '',
        nextFocusUp: '',
        nextFocusDown: 'focus-2-5-border',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/transparent.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/imgbox.png",
        click: onKeyEnter,
    ...
    },
    {
        ...
        nextFocusRight: 'focus-2-5-border',
        ...
        type: 'img',
        indexId: 'focus-2-5',
        title: 'focus-2-5-title',
        nextFocusLeft: 'focus-2-4-border',
        nextFocusRight: '',
        nextFocusUp: 'focus-1-5-border',
        nextFocusDown: '',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/transparent.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Channel/V4/imgbox.png",
                ...
                case DATA_TYPE_VIDEO:
                    ...
                    try {
                        ...
                        if (RenderParam.carrierId == "450094") {
                            ...
                            if (LMEPG.Func.isAllowAccess(RenderParam.isVip, ACCESS_PLAY_VIDEO_TYPE, videoInfo) || RenderParam.isPacketVip == '1') {
...
function onFocusChange(btn, hasFocus) {
    ...
    if (tempRow === 1 || tempRow === 2) {
        if (hasFocus) {
            LMEPG.CssManager.addClass(G(btn.indexId+'-src'),'src-focus')
            LMEPG.CssManager.addClass(G(btn.indexId+'-icon'),'icon-focus')
        } else {
            LMEPG.CssManager.removeClass(G(btn.indexId+'-src'),'src-focus')
            LMEPG.CssManager.removeClass(G(btn.indexId+'-icon'),'icon-focus')
        }
    }
}
