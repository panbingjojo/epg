 ...
 * @param works
 */
function jumpAlbum(albumName, works) {
    var configInfo = {
        entryType: 13,
    ...
    objCurrent.setParam('keyWords', works);
...
function updateArrows(pagingDirectionFlag) {
    ...
    if (pageTotal > 1 && pageTotal != pageCurrent) {
        S(uiArrowBottomElement);
    } else {
        H(uiArrowBottomElement);
    }
}
...
var userId = RenderParam.userId;               //用户id
var platformType = RenderParam.platformType;                  // 高清
var isVip = RenderParam.isVip; // 用户是不是vip，1、是vip，其他不是vip
var isReturnFlag = RenderParam.isReturn; // 0--表示直接进来，1--表示购买返回，2--表示播放返回
var keyWords = RenderParam.keyWords; // 搜索的关键字
var fromId = RenderParam.fromId;
var focusId = RenderParam.focusIndex;
focusId = focusId ? focusId : 'focus-1-1';
var page = parseInt(RenderParam.currentPage) || 1;
var borderImgGetUrl = '/Public/img/' + RenderParam.platformType + '/Search/V7/imgbox.png';       //图片获取焦点的背景图


var borderImgLoseUrl = '/Public/img/' + RenderParam.platformType + '/Search/V7/transparent.png';        //图片失去焦点的背景图
...
window.onload = function () {
    if (parseInt(isReturnFlag) > 0) {
        if (keyWords != '') {
            uiSearchTextElement.innerHTML = keyWords;
        }
    }
    LMEPG.ButtonManager.init('focus-1-1', buttons, '', true);
    searchVideoByHotWord(keyWords, focusId);
};
...
function updateNineKeyboardSrcWithClick(storeID) {
    ...
    if (platformType == 'hd') {
        currEle.style.height = '160px';
        currEle.style.width = '160px';
        currEle.style.top = '-20px';
        currEle.style.left = '-16px';
    } else {
...
function updateNineKeyboardSrcWithBack(storeID) {
    ...
    nineKeyboardClickStatus = false;
    if (platformType == 'hd') {
        currEle.style.height = '83px';
        currEle.style.width = '130px';
        currEle.style.top = '20px';
        currEle.style.left = '-2px';
    } else {
        currEle.style.height = '90px';
        currEle.style.width = '90px';
        currEle.style.top = '0px';
...
function updateSearch(direction, currId) {
    ...
    if (currMapKey == undefined || currMapKey == '') {
        var keyDOM = G(currID);
        var onBlurImage = LMEPG.ButtonManager.getCurrentButton().focusImage;//获得焦点事件id
        if (platformType == 'hd') {
            keyDOM.src = onBlurImage;
            keyDOM.style.height = '83px';
            keyDOM.style.width = '130px';
            keyDOM.style.top = '20px';
            keyDOM.style.left = '-2px';
        }
...
function marqueeUI(nextID) {
    ...
    LMEPG.UI.Marquee.start(nextID, 8, 2, 50, 'left', 'scroll');
}
            ...
            switch (item.type) {
                ...
                case DATA_TYPE_VIDEO:
                    ...
                    try {
                        ...
                        var videoUrl = (platformType == 'hd' ? videoUrlObj.gq_ftp_url : videoUrlObj.bq_ftp_url);
                        var videoInfo = {
...
var buttons = [
    {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword1_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword1_in.png',
        bigImg: '',
        click: onKeyCenter,
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword2_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword2_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword2_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword3_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword3_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword3_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword4_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword4_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword4_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword5_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword5_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword5_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword6_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword6_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword6_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword7_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword7_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword7_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword8_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword8_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword8_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword9_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword9_in.png',
        bigImg: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword9_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/del_btn_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/del_btn_in.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword0_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/keyword0_in.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/back_btn_out.png',
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/back_btn_in.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Search/V7/imgbox.png',
        click: onKeyCenter,
