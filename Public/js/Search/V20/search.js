...
var KeyWord = {
        ...
        buttons.push(
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_1.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_1.png",
                bigImg: "",
            ...
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_2.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_2.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_2.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_3.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_3.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_3.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_4.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_4.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_4.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_5.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_5.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_5.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_6.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_6.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_6.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_7.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_7.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_7.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: ""
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_8.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_8.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_8.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_9.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_9.png",
                bigImg: g_appRootPath + "/Public/img/hd/Search/V20/select_keyword_9.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_clear.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_clear.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_keyword_0.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_keyword_0.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            },
            {
                ...
                focusable: true,
                backgroundImage: g_appRootPath + "/Public/img/hd/Search/V20/bg_back.png",
                focusImage: g_appRootPath + "/Public/img/hd/Search/V20/f_back.png",
                click: KeyWord.onKeyCenter,
                beforeMoveChange: KeyWord.onBeforeMoveChange,
                moveChange: "",
            })
    ...
    searchAdd: function (text) {
        if (!LMEPG.Func.isEmpty(text)) {
            ...
            } else if (RenderParam.carrierId === '10220095' && currentText.length >= 10) { // 吉林电信魔方的检索字母长度最多显示10
                LMEPG.UI.showToast("首字母最多只能输入10位！");
            } else {
...
var CollectionContent = {
    ...
    createElements: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var defaultImg = g_appRootPath + '/Public/img/hd/Home/V20/Common/default.png';
            ...
            if (RenderParam.carrierId != '10220094' && RenderParam.carrierId != '10220095') {
                html += '<p id="' + itemContainerId + '_title"/>' + data[i].title + '</p>';
            }
