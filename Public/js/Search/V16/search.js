...
var Search = {
    ...
    searchWord: '',
    isHD: true,
    imgPrefix: g_appRootPath+'/Public/img/hd/Search/V16/',
    init: function () {
        this.isHD = RenderParam.platformType !== 'sd';
        // this.imgPrefix = '/Public/img/' + RenderParam.platformType + '/Search/V16/';
    ...
    createButtons: function () {
        ...
        while (COUNT_KEYS--) {
            var ImageIndex = g_appRootPath+'/Public/img/hd/Search/V16/key' + COUNT_KEYS;
            self.buttons.push({
                id: 'key-' + COUNT_KEYS,
                name: '键-' + COUNT_KEYS,
                type: 'img',
        ...
        self.buttons.push({
            ...
            nextFocusDown: 'key-0',
            backgroundImage: g_appRootPath+'/Public/img/hd/Search/V16/delete.png',
            focusImage: g_appRootPath+'/Public/img/hd/Search/V16/delete_f.png',
            ...
            nextFocusDown: 'key-9',
            backgroundImage: g_appRootPath+'/Public/img/hd/Search/V16/clear.png',
            focusImage: g_appRootPath+'/Public/img/hd/Search/V16/clear_f.png',
            click: self.clear,
            Obj: self
        });
    },
    ...
    setFirstSearchTabIndex: function () {
        ...
        // G('single-video').style.backgroundImage = 'url(' + (this.isHD ? '/Public/img/hd/Search/V16/nav_s.png' : g_appRootPath + '/Public/img/sd/Unclassified/V16/tab_s.png') + ')';
        G('single-video').style.backgroundImage = 'url(__ROOT__/Public/img/hd/Search/V16/nav_s.png)';
    },
...
var Tab = {
    ...
    createBtns: function () {
        ...
        // var navTabBgImg = Search.isHD ? '/Public/img/hd/Search/V16/nav_bg.png' : g_appRootPath + '/Public/img/sd/Unclassified/V16/tab_bg.png';
        // var navTabFocusImg = Search.isHD ? '/Public/img/hd/Search/V16/nav_f.png' : g_appRootPath + '/Public/img/sd/Unclassified/V16/tab_f.png';
        var navTabBgImg = g_appRootPath+ '/Public/img/hd/Search/V16/nav_bg.png';
        var navTabFocusImg = g_appRootPath+'/Public/img/hd/Search/V16/nav_f.png';
        Search.buttons.push({
            id: 'single-video',
            name: '视频',
            type: 'div',
            ...
            type: 'div',
            nextFocusLeft: 'album',
            nextFocusRight: Search.isHD ? 'expert' : "",
            nextFocusUp: 'key-0',
            nextFocusDown: 'v-0',
            backgroundImage: navTabBgImg,
            focusImage: navTabFocusImg,
    ...
    onFocusIn: function (btn, hasFocus) {
        ...
        if (hasFocus) {
            ...
            // G(btn.id).style.backgroundImage = 'url(' + (Search.isHD ? '/Public/img/hd/Search/V16/nav_s.png' : g_appRootPath + '/Public/img/sd/Unclassified/V16/tab_s.png') + ')';
            G(btn.id).style.backgroundImage = 'url(__ROOT__/Public/img/hd/Search/V16/nav_s.png)';
        }
    },
    ...
    focusChange: function (btn, hasFocus) {
        ...
        if (hasFocus) {
            ...
            if (txtEl) {
                ...
                // LMEPG.Func.marquee(txtEl, {wordsW: 5}, true);
            }
