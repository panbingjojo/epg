...
function createElements(list) {
    ...
    for (var dataIndex = 0; dataIndex < list.length; dataIndex++) {
        ...
        uiImgBorder.setAttribute('src', '/Public/img/hd/Search/V21/transparent.png');
...
var borderImgGetUrl =  g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Home/V22/Common/imgbox.png';       //图片获取焦点的背景图


var borderImgLoseUrl = g_appRootPath +  '/Public/img/' + RenderParam.platformType + '/Search/V21/transparent.png';        //图片失去焦点的背景图
...
var buttons = [
    {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword1_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword1_in.png',
        bigImg: '',
        click: onKeyCenter,
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword2_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword2_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword2_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword3_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword3_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword3_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword4_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword4_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword4_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword5_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword5_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword5_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword6_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword6_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword6_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword7_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword7_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword7_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword8_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword8_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword8_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword9_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword9_in.png',
        bigImg: g_appRootPath + '/Public/img/hd/Search/V21/keyword9_confrim.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/del_btn_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/del_btn_in.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword0_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/keyword0_in.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + '/Public/img/hd/Search/V21/back_btn_out.png',
        focusImage: g_appRootPath + '/Public/img/hd/Search/V21/back_btn_in.png',
        click: onKeyCenter,
        beforeMoveChange: keyWordsDir,
        moveChange: ''
    }, {
        ...
        focusImage: g_appRootPath + '/Public/img/' + RenderParam.platformType + '/Home/V22/Common/imgbox.png',
...
window.onload = function () {
    document.body.style.backgroundImage = 'url('+(RenderParam.themePicture?RenderParam.fsUrl+RenderParam.themePicture:"/Public/img/hd/Home/V22/Common/bg_1.png")+')'
