        ...
        if (typeof window.top != 'undefined' && typeof window.top.jk39 != 'undefined') {
            ...
            window.top.jk39.auth({
                    ...
                    callback: function (result) {
                        ...
                        LMEPG.Log.info('[auth10220094]--->[doAuth][result]--->鉴权结果 vipState: ' + result+" jk39ProductId:"+jk39ProductId);
                        var EPGParams = SplashController10220094.getEPGParams();
            ...
            LMEPG.AuthUser.authByNetwork(EPGParams, successFunc, failFunc);
            LMEPG.Log.info('[auth10220094]--->[doAuth]--->测试-鉴权产品id: ' + RenderParam.productId);
        }
