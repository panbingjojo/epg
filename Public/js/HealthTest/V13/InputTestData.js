    ...
    createBtns: function () {
        this.buttons.push(
            //检测时间虚拟按钮
            {
                ...
                backgroundImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V13/test_time.png' : g_appRootPath + '/Public/img/hd/HealthTest/V13/test_time.png',
                focusImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V13/test_time_f.png' : g_appRootPath + '/Public/img/hd/HealthTest/V13/test_time_f.png',
            ...
            , {
                ...
                backgroundImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/prev.png',
                focusImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/prev_f.png',
                ...
                nextFocusDown: 'input-number',
                backgroundImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/next.png',
                focusImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/next_f.png',
                beforeMoveChange: TestType.turnInner
            }
            // 检测数值虚拟按钮
            , {
                ...
                backgroundImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V13/test_number.png' : g_appRootPath + '/Public/img/hd/HealthTest/V13/test_number.png',
                focusImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V13/test_number_f.png' : g_appRootPath + '/Public/img/hd/HealthTest/V13/test_number_f.png',
            ...
            , {
                ...
                nextFocusRight: 'member-next',
                nextFocusDown: 'status-prev',
                backgroundImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/btn_add.png',
                focusImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/btn_add_f.png',
            ...
            , {
                ...
                focusImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/submit_f.png',
                backgroundImage: g_appRootPath + '/Public/img/hd/HealthTest/V13/submit.png',
...
var TestMember = {
    ...
    updateInput: function () {
        ...
        if (that.data.length > 0 && that.count < that.data.length) { // 成员数目大于0 且小于8个
            ...
            G('input-member').innerHTML = '<img id="member-add" align="center" src="' + g_appRootPath + '/Public/img/hd/HealthTest/V13/btn_add.png" alt="">';
