...
var TestRecord = {
    ...
    recordDataTable: function () {
        ...
        this.currentData.forEach(function (t, i) {
            ...
            htm += '<tr id=focus-' + i + ' class="' + trClassName + '">' +
                ...
                '<td class="test-delete"><img id="delete-' + i + '" src="' + g_appRootPath + '/Public/img/hd/HealthTest/V16/deleteRecord.png" measureId="' + t.measure_id + '" alt=""></tr>';
        });
    ...
    initFocusData: function (name, item) {
        LMEPG.BM.getButtonById('test-item').backgroundImage = g_appRootPath + '/Public/img/hd/HealthTest/V16/test_' + item + '.png';
        LMEPG.BM.getButtonById('test-item').focusImage = g_appRootPath + '/Public/img/hd/HealthTest/V16/test_' + item + '_f.png';
        G('title').innerHTML = RenderParam.member_name + name;
        G('test-item').src = g_appRootPath + '/Public/img/hd/HealthTest/V16/test_' + item + '.png';
        G('person-pic').src = g_appRootPath + '/Public/img/hd/HealthTest/V16/member_' + RenderParam.member_image_id + '.png';
    },
    ...
    createButtons: function () {
        this.buttons.push({
            ...
            // focusImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V13/tab_test_f.png' : g_appRootPath + '/Public/img/hd/HealthTest/V16/tab_f.png',
            focusImage: g_appRootPath + '/Public/img/hd/HealthTest/V16/tab_f.png',
            ...
            nextFocusDown: 'tab-0',
            backgroundImage: g_appRootPath + '/Public/img/hd/HealthTest/V16/write_data.png',
            focusImage: g_appRootPath + '/Public/img/hd/HealthTest/V16/write_data_f.png',
        ...
        while (count--) {
            this.buttons.push({
                ...
                backgroundImage: g_appRootPath + '/Public/img/hd/HealthTest/V16/deleteRecord.png',
                focusImage: g_appRootPath + '/Public/img/hd/HealthTest/V16/deleteRecord_f.png',
