    ...
    render: function () {
        ...
        if (isNullData) {
            ...
            this.dataList.forEach(function (t, i) {
                htm += '<li id=focus-' + i + '>' +
                    '<img onerror="this.src=\'' + g_appRootPath + '/Public/img/hd/Home/V20/Common/default   .png\'" src=' + RenderParam.fsUrl + t.image_url + '><p id=focus-' + i + 'title>' + t.title + '</p>';
            });
    ...
    createBtns: function () {
        ...
        while (VIDEO_COUNT--) {
            this.buttons.push({
                ...
                nextFocusUp: VIDEO_COUNT < 3 ? 'clear-record' : 'focus-' + (VIDEO_COUNT - 3),
                ...
                // focusImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V20/video_list_f.png' : g_appRootPath + '/Public/img/hd/HistoryPlay/V20/video_list_f.png',
                focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/video_list_f.png',
        ...
        this.buttons.push({
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/clear.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/clear_f.png',
            ...
            nextFocusUp: 'focus-3',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/first_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/first_page_f.png',
            ...
            nextFocusUp: 'focus-3',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/prev_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/prev_page_f.png',
            click: this.prevPage,
            beforeMoveChange: this.onMoveChangeMoveToId
        }, {
            id: 'next-page',
            ...
            nextFocusUp: 'focus-2',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/next_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/next_page_f.png',
            click: this.nextPage,
            beforeMoveChange: this.onMoveChangeMoveToId
        }, {
            id: 'last-page',
            ...
            nextFocusUp: 'focus-2',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/last_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V20/last_page_f.png',
            click: this.lastPage,
            beforeMoveChange: this.onMoveChangeMoveToId
        });
    ...
    getHistoryPlayList: function (page, callback) {
        ...
        LMEPG.ajax.postAPI('Video/getHistoryPlayList', postData, function (data) {
            ...
            if (data.result == 0) {
                ...
                HistoryPlay.maxPage = Math.ceil(data.count / 6);
