    ...
    render: function () {
        ...
        if (isNullData) {
            ...
            this.dataList.forEach(function (t, i) {
                htm += '<li id=focus-' + i + ' class="kod">' +
                    '<img onerror="this.src=' + defaultImg + '" src=' + RenderParam.fsUrl + t.image_url + '>';
                // '<p>' + t.title + '</p>';
            });
    ...
    createBtns: function () {
        ...
        while (VIDEO_COUNT--) {
            this.buttons.push({
                ...
                // focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/video_list_f.png',
        ...
        this.buttons.push({
                ...
                backgroundImage: g_appRootPath + '/Public/img/hd/Home/V22/Collect/clear.png',
                focusImage: g_appRootPath + '/Public/img/hd/Home/V22/Collect/clear_f.png',
            ...
            //     nextFocusUp: 'focus-3',
            //     backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/first_page.png',
            //     focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/first_page_f.png',
            ...
            //     nextFocusUp: 'focus-4',
            //     backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/prev_page.png',
            //     focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/prev_page_f.png',
            //     click: this.prevPage,
            //     beforeMoveChange: this.onMoveChangeMoveToId
            // }, {
            //     id: 'next-page',
            ...
            //     nextFocusUp: 'focus-4',
            //     backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/next_page.png',
            //     focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/next_page_f.png',
            //     click: this.nextPage,
            //     beforeMoveChange: this.onMoveChangeMoveToId
            // }, {
            //     id: 'last-page',
            ...
            //     nextFocusUp: 'focus-5',
            //     backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/last_page.png',
            //     focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V16/last_page_f.png',
            //     click: this.lastPage,
            //     beforeMoveChange: this.onMoveChangeMoveToId
            // }
        );
