var HistoryPlay = {
    ...
    isNullData: function () {
        if (this.dataList.length == 0) {
            G('list-wrapper').innerHTML = '<li class=null-data>还没有播放记录，快去开始您的健康之旅吧！';
            H('page-wrapper');
            H('prev-arrow');
            H('next-arrow');
    ...
    toggleFocus: function (btn, hasFocus) {
        ...
        if (hasFocus) {
            LMEPG.Func.marquee(btnElement,btnElement.innerText, 10);
        } else{
    ...
    createBtns: function () {
        ...
        while (VIDEO_COUNT--) {
            this.buttons.push({
                ...
                focusImage: RenderParam.platformType == 'sd' ? g_appRootPath + '/Public/img/sd/Unclassified/V13/video_list_f.png' : RenderParam.carrierId == '11000051' ?  g_appRootPath + '/Public/img/hd/HistoryPlay/V13/video_list_1_f.png':g_appRootPath + '/Public/img/hd/HistoryPlay/V13/video_list_f.png',
        ...
        this.buttons.push({
            ...
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V24/history_no_choose.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V24/history_choose.png',
            ...
            nextFocusUp: 'focus-3',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/first_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/first_page_f.png',
            ...
            nextFocusUp: 'focus-4',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/prev_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/prev_page_f.png',
            click: this.prevPage,
            beforeMoveChange: this.onMoveChangeMoveToId
        }, {
            id: 'next-page',
            ...
            nextFocusUp: 'focus-4',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/next_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/next_page_f.png',
            click: this.nextPage,
            beforeMoveChange: this.onMoveChangeMoveToId
        }, {
            id: 'last-page',
            ...
            nextFocusUp: 'focus-5',
            backgroundImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/last_page.png',
            focusImage: g_appRootPath + '/Public/img/hd/HistoryPlay/V13/last_page_f.png',
            click: this.lastPage,
            beforeMoveChange: this.onMoveChangeMoveToId
        });
