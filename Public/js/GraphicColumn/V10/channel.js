...
var Channel = {
    init: function () {
        ...
        G(RenderParam.navFocusIndex || LMEPG.ButtonManager.getSelectedButton("nav").id).style.color = '#27a5bd';
    },
    ...
    initRecommendPosition: function () {
        ...
        buttons.push({
            ...
            selectedImage: g_appRootPath + "/Public/img/hd/Home/V10/select_search.png",
    ...
    createNavPart: function (data) {
        ...
        for (var i = 0; i < navList.length; i++) {
            htmlStr += '<div id="btn-nav-' + (i + 1) + '" pos="' + (i + this.page) +
                '"  class="nav-btn">' + data[i + this.page].class_name + '</div>';
