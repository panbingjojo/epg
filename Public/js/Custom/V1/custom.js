var Custom = {
    ...
    renderPage: function() {
        ...
        /*var imgCurrent = new Image();
         ...
         imgCurrent.src = g_appRootPath+'/Public/img/hd/Custom/current_s.png';
        ...
        for (var i = 0; i < Custom.curData.length; i++) {
            ...
            for (var k = 0; k < userSkinList.length; k++) {
                if (Custom.curData[i].skin_id == userSkinList[k].skin_id && userSkinList[k].in_use == 1) {
                    labelHtml = '<img id ="current-icon" src="' + g_appRootPath + '/Public/img/hd/Custom/current_s.png" alt=""/>';
                    break;
                }
            }
            ...
            if (Custom.curData[i].skin_id == -1) {
                var img = g_appRootPath + '/Public/img/hd/Custom/default_bg_left.png';
            } else{
        ...
        if (hasFocus) {
            ...
            if (Custom.curData[index].skin_id == -1) {
                if (RenderParam.carrierId == '320092'
                    ...
                    G('big-bg-preview').src =g_appRootPath+ '/Public/img/hd/Custom/default_bg_right_450092.png';
                }else if(RenderParam.carrierId == '420092'){
                    G('big-bg-preview').src = g_appRootPath+'/Public/img/hd/Custom/default_bg_right_420092.png';
                }else if(RenderParam.carrierId == '410092'){
                    G('big-bg-preview').src =g_appRootPath+ '/Public/img/hd/Custom/default_bg_right_410092.png';
                }else if(RenderParam.carrierId == '620092'){
                    G('big-bg-preview').src = g_appRootPath+'/Public/img/hd/Custom/default_bg_right_620092.png';
                }else if(RenderParam.carrierId == '610092'){
                    G('big-bg-preview').src =g_appRootPath+ '/Public/img/hd/Custom/default_bg_right_610092.png';
                }else {
                    G('big-bg-preview').src =g_appRootPath+ '/Public/img/hd/Custom/default_bg_right.png';
                }
            } else{
            ...
            // 使用
            if (isHasSkin) {
                Custom.buttons[4].backgroundImage = g_appRootPath+'/Public/img/hd/Custom/btn_use.png';
                Custom.buttons[4].focusImage =g_appRootPath+ '/Public/img/hd/Custom/btn_use_f.png';
                G(Custom.buttons[4].id).src =g_appRootPath+ '/Public/img/hd/Custom/btn_use.png';
                G('cost').innerHTML = '';
            }
            // 兑换
            else{
                Custom.buttons[4].backgroundImage = g_appRootPath+'/Public/img/hd/Custom/btn_exchange.png';
                Custom.buttons[4].focusImage =g_appRootPath+ '/Public/img/hd/Custom/btn_exchange_f.png';
                G(Custom.buttons[4].id).src = g_appRootPath+'/Public/img/hd/Custom/btn_exchange.png';
     ...
     * 取消积分兑换，免费兑换
     */
    FreeScoreExchange: function() {
        G("my-score").style.display = "none";
        G("cost").style.display = "none";
    },
    ...
    initSwitchButton: function() {
        ...
        if (state == 0) { // 未开启状态，显示开启的按钮
            btn.backgroundImage = g_appRootPath+'/Public/img/hd/Custom/btn_auto_update_open.png';
            btn.focusImage =g_appRootPath+ '/Public/img/hd/Custom/btn_auto_update_open_f.png';
            if (LMEPG.BM.getCurrentButton() && LMEPG.BM.getCurrentButton().id == btn.id) {
                G(btn.id).src = g_appRootPath+'/Public/img/hd/Custom/btn_auto_update_open_f.png';
            } else{
                G(btn.id).src =g_appRootPath+ '/Public/img/hd/Custom/btn_auto_update_open.png';
            }
        } else{ // 开启状态，显示关闭的按钮
            btn.backgroundImage =g_appRootPath+ '/Public/img/hd/Custom/btn_auto_update_close.png';
            btn.focusImage = g_appRootPath+'/Public/img/hd/Custom/btn_auto_update_close_f.png';
            if (LMEPG.BM.getCurrentButton() && LMEPG.BM.getCurrentButton().id == btn.id) {
                G(btn.id).src = g_appRootPath+'/Public/img/hd/Custom/btn_auto_update_close_f.png';
            } else{
                G(btn.id).src = g_appRootPath+'/Public/img/hd/Custom/btn_auto_update_close.png';
            }
        }
    },
    ...
    createBtns: function() {
        ...
        this.buttons.push({
            ...
            focusImage: RenderParam.platformType == 'sd' ?g_appRootPath+'/Public/img/sd/Unclassified/V13/bg_s_f.png':g_appRootPath+ '/Public/img/hd/Custom/bg_s_f.png',
            click: '',
            ...
            backgroundImage:g_appRootPath+ '/Public/img/hd/Custom/btn_auto_update_open.png',
            focusImage: g_appRootPath+'/Public/img/hd/Custom/btn_auto_update_open_f.png',
            focusChange: ''
        }, {
            id: 'exchange',
            name: '兑换/使用',
            ...
            nextFocusUp: 'switch',
            backgroundImage:g_appRootPath+ '/Public/img/hd/Custom/btn_exchange.png',
            focusImage: g_appRootPath+'/Public/img/hd/Custom/btn_exchange_f.png',
            click: RenderParam.carrierId=="500092" || RenderParam.carrierId=="450092" ? Network.onExchangeOrUse:Network.useSkin,
            beforeMoveChange: this.onBeforeMoveChange
        });
