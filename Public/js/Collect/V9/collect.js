...
function updateUI(flag) {
    try {
        ...
        var leftArrowArrow = document.getElementById("arrow-left");
        var rightArrowArrow = document.getElementById("arrow-right");
        ...
        function createHtml() {
            ...
            for (var dataIndex = 0; dataIndex < localData.length; dataIndex++) {
                ...
                html += '<div id="focus-1-' + (dataIndex + 1) + '" sid="' + sourceId + '" usertype="' + userType + '" ftp=\'' + ftpUrl + '\' title="' + title + '" modelType="' + modelType + '" freeSeconds="' + freeSeconds + '" unionCode="' + unionCode + '">';
                ...
                html += '<div id="focus-2-' + (dataIndex + 1) + '-btn" status="1" sid="' + sourceId + '" style="background: url(__ROOT__/Public/img/' + RenderParam.platformType + '/Menu/QHotherPages/btn_uncollect.png) no-repeat;"></div>';
    ...
    LMEPG.ajax.postAPI("Collect/clearCollectRecord", null, function (rsp) {
        try {
            ...
            if (collectItem.result == 0) {
                ...
                content.innerHTML = "";
                if (uiPageFlag === null) {
                    uiPageFlag = document.getElementById("page-num");
                }
...
function marqueeUI(nextID) {
    ...
    var MAX_roll = RenderParam.platformType == "hd" ? 10 : 7;
    LMEPG.UI.Marquee.start(nextID, MAX_roll, 2, 50, "left", "scroll");
}
...
var buttons = [
    {
        ...
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/clearCollect.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/clearCollect_f.png",
        bigImg: "",
        click: onKeyEnter,
        focusChange: onFocus
    },
    {
        ...
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/Tab5/levelThree_f.png",
        click: onKeyEnter,
    ...
    },
    {
        ...
        nextFocusDown: '',
        focusable: true,
        backgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/btn_uncollect.png",
        focusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/btn_uncollect_f.png",
        click: onKeyEnter,
        focusChange: onFocusChangeBtn,
        beforeMoveChange: onBeforeMoveChange,
        moveChange: "",
        cBackgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/btn_collect.png",
        cFocusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/btn_collect_f.png"
    },
    {
        id: "focus-2-2-btn",
        name: "按钮2号位",
    ...
    },
    {
        ...
        beforeMoveChange: onBeforeMoveChange,
        moveChange: "",
        cBackgroundImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/btn_collect_f.png",
        cFocusImage: g_appRootPath + "/Public/img/" + RenderParam.platformType + "/Menu/QHotherPages/btn_collect_f.png"
    }
];