        ...
        if (isNullData) {
            ...
            this.currentData.forEach(function (t, i) {
                ...
                if (t.collectStatus == 1 || t.collectStatus == undefined) {
                    var collectStatusImg =g_appRootPath+ '/Public/img/hd/Home/V22/Collect/collect.png';
                } else {
                    var collectStatusImg = g_appRootPath+'/Public/img/hd/Home/V22/Collect/uncollect.png';
                }
    ...
    createBtns: function () {
        ...
        while (NAV_COUNT--) {
            this.buttons.push({
                ...
                backgroundImage: g_appRootPath+'/Public/img/hd/Home/V22/Collect/nav_' + (NAV_COUNT + 1) + '.png',
                focusImage:g_appRootPath+ '/Public/img/hd/Home/V22/Collect/nav_' + (NAV_COUNT + 1) + '_f.png',
                selectedImage2: g_appRootPath+'/Public/img/hd/Home/V22/Collect/nav_' + (NAV_COUNT + 1) + '_select.png',
        ...
        while (VIDEO_COUNT--) {
            this.buttons.push({
                ...
                backgroundImage:g_appRootPath+ '/Public/img/hd/Home/V22/Collect/collect.png',
                focusImage: g_appRootPath+'/Public/img/hd/Home/V22/Collect/collect_f.png',
        ...
        LMEPG.ajax.postAPI('Collect/setCollectStatusNew', postData, function (rsp) {
            try {
                ...
                if (collectItem.result == 0) {
                    if (postData.type == 0) {
                        //收藏成功
                        G(btnId).src = g_appRootPath+'/Public/img/hd/Home/V22/Collect/collect_f.png';
                        Collect.dataList[index].collectStatus = 1;
                        // 更新按钮的图片
                        for (var i = 0; i < Collect.buttons.length; i++) {
                            if (Collect.buttons[i].id == btnId) {
                                Collect.buttons[i].backgroundImage =g_appRootPath+ '/Public/img/hd/Home/V22/Collect/collect.png';
                                Collect.buttons[i].focusImage =g_appRootPath+ '/Public/img/hd/Home/V22/Collect/collect_f.png';
                                break;
                            }
                        }
                    } else {
                        //取消收藏成功
                        G(btnId).src =g_appRootPath+ '/Public/img/hd/Home/V22/Collect/uncollect_f.png';
                        Collect.dataList[index].collectStatus = 0;
                        // 更新按钮的图片
                        for (var i = 0; i < Collect.buttons.length; i++) {
                            if (Collect.buttons[i].id == btnId) {
                                Collect.buttons[i].backgroundImage =g_appRootPath+ '/Public/img/hd/Home/V22/Collect/uncollect.png';
                                Collect.buttons[i].focusImage =g_appRootPath+ '/Public/img/hd/Home/V22/Collect/uncollect_f.png';
                                break;
                            }
                        }
                    }
