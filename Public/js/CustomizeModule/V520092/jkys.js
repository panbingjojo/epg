var Page = {
    ...
    jumpPage:function (res){
        ...
        res.entry_type == moduleCommon.EntryType.HEALTH_VIDEO && moduleCommon.jumpPlayVideo(moduleCommon.ModuleId.JKYS,res);
        res.entry_type == moduleCommon.EntryType.HEALTH_VIDEO_BY_TYPES && moduleCommon.jumpVideoList(moduleCommon.ModuleId.JKYS,res);
        res.entry_type == moduleCommon.EntryType.HEALTH_VIDEO_SET && moduleCommon.jumpVideoSet(moduleCommon.ModuleId.JKYS,res);
    },
    /**
     * 获取按键对应str字符
     * @param keyCode
    ...
    containerMarginTop: function (nextFocus) {
        ...
        /^(2)-\d+$/gi.test(nextFocus) && (result = -360 * 1);
        /^(3)-\d+$/gi.test(nextFocus) && (result = -360 * 2.5);
        /^(4)-\d+$/gi.test(nextFocus) && (result = -360 * 3);
    ...
    initPageButtons: function () {
        Page.data.pageButtons = {
            "P1-0": Page.buildButtonItem("P1-0", "", "2-0", "", "2-0"),

            "P2-0": Page.buildButtonItem("P2-0", "1-0", "2-2", "1-0", "2-1"),
            "P2-1": Page.buildButtonItem("P2-1", "1-0", "2-2", "2-0", "2-2"),
            "P2-2": Page.buildButtonItem("P2-2", "2-0", "3-0", "2-1", "2-3"),
            "P2-3": Page.buildButtonItem("P2-3", "2-0", "3-0", "2-2", "2-4"),
            "P2-4": Page.buildButtonItem("P2-4", "2-1", "3-0", "2-3", "3-0"),

            "P3-0": Page.buildButtonItem("P3-0", "2-2", "3-1", "2-4", "3-1"),
            "P3-1": Page.buildButtonItem("P3-1", "3-0", "4-0", "3-0", "3-2"),
            "P3-2": Page.buildButtonItem("P3-2", "3-0", "4-0", "3-1", "3-3"),
            "P3-3": Page.buildButtonItem("P3-3", "3-0", "4-0", "3-2", "3-4"),
            "P3-4": Page.buildButtonItem("P3-4", "3-0", "4-0", "3-3", "3-5"),
            "P3-5": Page.buildButtonItem("P3-5", "3-0", "4-0", "3-4", "4-0"),

            "P4-0": Page.buildButtonItem("P4-0", "3-1", "", "3-5", "4-1"),
            "P4-1": Page.buildButtonItem("P4-1", "3-1", "", "4-0", "4-2"),
            "P4-2": Page.buildButtonItem("P4-2", "3-1", "", "4-1", "4-3"),
            "P4-3": Page.buildButtonItem("P4-3", "3-1", "", "4-2", ""),
    ...
    buildPostionHtml: function (key, list) {
        ...
        for (var i = 0; i < list.length; i++) {
            if(key === "P1"){
                result = Page.buildElHtmlImage(key, 0, list[0]);
            }else {
