var Page = {
    ...
    jumpPage:function (res){
        ...
        res.entry_type == moduleCommon.EntryType.HEALTH_VIDEO && moduleCommon.jumpPlayVideo(moduleCommon.ModuleId.JKZS,res);
        res.entry_type == moduleCommon.EntryType.HEALTH_VIDEO_BY_TYPES && moduleCommon.jumpVideoList(moduleCommon.ModuleId.JKZS,res);
        res.entry_type == moduleCommon.EntryType.HEALTH_VIDEO_SET && moduleCommon.jumpVideoSet(moduleCommon.ModuleId.JKZS,res);
    },
    /**
     * 获取按键对应str字符
     * @param keyCode
    ...
    containerMarginTop: function (nextFocus) {
        ...
        /^(3)-\d+$/gi.test(nextFocus) && (result = -360 * 2.9);
    ...
    initPageButtons: function () {
        Page.data.pageButtons = {
            "P1-0": Page.buildButtonItem("P1-0", "", "1-2", "", "1-1"),
            "P1-1": Page.buildButtonItem("P1-1", "", "1-4", "1-0", "1-2"),
            "P1-2": Page.buildButtonItem("P1-2", "1-0", "2-0", "1-1", "1-3"),
            "P1-3": Page.buildButtonItem("P1-3", "1-0", "2-0", "1-2", "1-4"),
            "P1-4": Page.buildButtonItem("P1-4", "1-1", "2-0", "1-3", "1-5"),
            "P1-5": Page.buildButtonItem("P1-5", "1-1", "2-0", "1-4", "2-0"),

            "P2-0": Page.buildButtonItem("P2-0", "1-2", "2-3", "1-5", "2-1"),
            "P2-1": Page.buildButtonItem("P2-1", "1-2", "2-3", "2-0", "2-2"),
            "P2-2": Page.buildButtonItem("P2-2", "1-2", "2-3", "2-1", "2-3"),
            "P2-3": Page.buildButtonItem("P2-3", "2-0", "3-0", "2-2", "2-4"),
            "P2-4": Page.buildButtonItem("P2-4", "2-0", "3-0", "2-3", "3-0"),

            "P3-0": Page.buildButtonItem("P3-0", "2-3", "3-4", "2-4", "3-1"),
            "P3-1": Page.buildButtonItem("P3-1", "2-3", "3-6", "3-0", "3-2"),
            "P3-2": Page.buildButtonItem("P3-2", "2-3", "3-7", "3-1", "3-3"),
            "P3-3": Page.buildButtonItem("P3-3", "2-3", "3-7", "3-2", "3-4"),
            "P3-4": Page.buildButtonItem("P3-4", "3-0", "", "3-3", "3-5"),
            "P3-5": Page.buildButtonItem("P3-5", "3-0", "", "3-4", "3-6"),
            "P3-6": Page.buildButtonItem("P3-6", "3-1", "", "3-5", "3-7"),
            "P3-7": Page.buildButtonItem("P3-7", "3-2", "", "3-6", "")
        }
    },
    /**
     * 构建焦点
