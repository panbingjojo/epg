 ...
 * Date: 2018-09-12
 * Time: 10:20
 * Brief: 此文件（或类）用于存放广西电信特有路由配置，它在应用运行时，将会与DefaultConf里的配置进行合并，
 *        并且会覆盖掉原来同名的配置。
 */
...
define("SPECIAL_VIEW_PAGES", "return array(
  /** 主页模块 */
    ...
    'inquiryCall' => '/Home/DoctorP2P/inquiryCallV1',                      // 视频问诊 - 小程序问诊页面
     ...
     'customizeModule' => '/Home/CustomizeModule/customizeModuleV1'  //特殊模块1 
);");
...
define('COMMON_PLAYER_VIEW', 'V3'); // 使用播放器的模式
