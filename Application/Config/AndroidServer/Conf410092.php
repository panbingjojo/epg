...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'server_cws' => [
            [
                'src_addr' => 'http://127.0.0.1:10100',
                'dest_addr' => 'http://127.0.0.1:10100',
            ],
        ],
        // 崩溃跟踪服务器
        'server_crash' => [
            [
                'src_addr' => 'http://222.85.91.211:10333',
                'dest_addr' => 'http://222.85.91.211:10333',
            ],
        ],
        // 互联网医院licode服务
        'hosp_licode' => [
            [
                ...
                'dest_addr' => 'ws://222.85.91.211:10335',
            ],
            [
        ...
        'hosp_stun' => [
            [
                ...
                'dest_addr' => 'turn:222.85.91.211:22000',
                'turn_username' => 'test',
                'turn_passwd' => 'testpwd',
            ],
        ],
        ...
        'hosp_inquiry_wss' => [
            [
                ...
                'dest_addr' => 'wss://222.85.91.211:10338',
            ],
        ],
        // 健康检测、直播、日志上传ES推送服务器
        'server_general_push' => [
            [
                'src_addr' => 'ws://222.85.91.211:10334',
                'dest_addr' => 'ws://222.85.91.211:10334',
            ],
        ],
        // 音频适配服务器
        'audio_adapter' => [
            [
                'src_addr' => 'http://222.85.91.211:10339',
                'dest_addr' => 'http://222.85.91.211:10339',
            ],
        ],
        // 客服电话
        'custmer_service_hotline' => [
