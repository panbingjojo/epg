...
if (ANDROID_SERVER_CONFIG_DEBUG) {
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://test-healthiptv.langma.cn:40037/001006-chinaunicom-ott/index.php',
                'dest_addr' => 'http://test-healthiptv.langma.cn:40037/001006-chinaunicom-ott/index.php',
...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://123.59.206.200:10002/epg-lws-for-apk-001006/index.php',
                'dest_addr' => 'http://123.59.206.200:10002/epg-lws-for-apk-001006/index.php',
            ],
        ],
        // 客服电话
        'customer_service_hotline' => [
