...
if (ANDROID_SERVER_CONFIG_DEBUG) {
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://test-healthiptv.langma.cn:40037/00440001-guangdongyd/index.php',
                'dest_addr' => 'http://test-healthiptv.langma.cn:40037/00440001-guangdongyd/index.php',
...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'server_cws' => [
            [
                'src_addr' => 'http://183.234.214.54:10013',
                'dest_addr' => 'http://183.234.214.54:10013',
            ],
        ],
        // 消息推送服务器
        'server_push' => [
        ...
        'server_file_system' => [
            [
                'src_addr' => 'http://183.234.214.54:10001/',
                'dest_addr' => 'http://183.234.214.54:10001/',
            ],
        ],
        // 崩溃跟踪服务器
        'server_crash' => [
            [
                'src_addr' => 'http://183.234.214.54:10005/',
                'dest_addr' => 'http://183.234.214.54:10005/',
            ],
        ],
        // 互联网医院web服务器
        'hosp_apis' => [
        ...
        'hosp_licode' => [
            [
                ...
                'dest_addr' => 'ws://183.234.214.54:10008',
            ],
            [
                'src_addr' => 'wss://webrtc1.hlwyy.cn:3004',
                'dest_addr' => 'ws://183.234.214.54:10009',
            ],
            [
                'src_addr' => 'wss://webrtc2.hlwyy.cn:3004',
                'dest_addr' => 'ws://183.234.214.54:10010',
            ],
        ],
        // 互联网医院ice服务
        'hosp_stun' => [
            [
                ...
                'dest_addr' => 'turn:183.234.214.54:20010',
                'turn_username' => 'test',
                'turn_passwd' => 'testpwd',
            ],
        ],
        ...
        'hosp_inquiry_wss' => [
            [
                ...
                'dest_addr' => 'wss://183.234.214.54:10011',
            ],
        ],
        // 健康检测、直播、日志上传ES推送服务器
        'server_general_push' => [
            [
                'src_addr' => 'http://183.234.214.54:10007',
                'dest_addr' => 'http://183.234.214.54:10007',
            ],
        ],
        // 音频适配服务器
        'audio_adapter' => [
            [
                'src_addr' => 'http://app.amx.langma.cn',
                'dest_addr' => 'http://183.234.214.54:10012',
            ],
        ],
        // APK2.0入口地址
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://183.234.214.54:10013/epg-lws-for-apk-440001/index.php',
                'dest_addr' => 'http://183.234.214.54:10013/epg-lws-for-apk-440001/index.php',
            ],
        ],
        // 客服电话
        'customer_service_hotline' => [
