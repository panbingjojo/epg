...
if (ANDROID_SERVER_CONFIG_DEBUG) {
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
               'src_addr' => 'http://test-healthiptv.langma.cn:40033/epg-lws-for-apk-130001/index.php',
               'dest_addr' => 'http://test-healthiptv.langma.cn:40033/epg-lws-for-apk-130001/index.php',
            ],
        ],
        // 客服电话
...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn/epg-lws-for-apk-130001/index.php',
                'dest_addr' => 'http://healthiptv.langma.cn/epg-lws-for-apk-130001/index.php',
            ],
        ],
        // 客服电话
        'customer_service_hotline' => [
