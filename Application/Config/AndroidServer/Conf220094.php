...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'server_cws' => [
            [
                'src_addr' => 'http://139.215.92.20:10000',
                'dest_addr' => 'http://139.215.92.20:10000',
            ],
        ],
        // 消息推送服务器
        'server_push' => [
        ...
        'server_file_system' => [
            [
                'src_addr' => 'http://139.215.92.20:10003/fs/',
                'dest_addr' => 'http://139.215.92.20:10003/fs/',
            ],
        ],
        // 崩溃跟踪服务器
        'server_crash' => [
            [
                'src_addr' => 'http://139.215.92.20:10007',
                'dest_addr' => 'http://139.215.92.20:10007',
            ],
        ],
        // 互联网医院web服务器
        'hosp_apis' => [
        ...
        'hosp_licode' => [
            [
                ...
                'dest_addr' => 'ws://139.215.92.20:10010',
            ],
            [
                'src_addr' => 'wss://webrtc1.hlwyy.cn:3004',
                'dest_addr' => 'ws://139.215.92.20:10011',
            ],
            [
                'src_addr' => 'wss://webrtc2.hlwyy.cn:3004',
                'dest_addr' => 'ws://139.215.92.20:10012',
            ],
        ],
        // 互联网医院ice服务
        'hosp_stun' => [
            [
                ...
                'dest_addr' => 'turn:139.215.92.20:20000',
                'turn_username' => 'test',
                'turn_passwd' => 'testpwd',
            ],
        ],
        ...
        'hosp_inquiry_wss' => [
            [
                ...
                'dest_addr' => 'wss://139.215.92.20:10014',
            ],
        ],
        // 直播服务licode 服务
        'hosp_live_licode' => [
            [
                ...
                'dest_addr' => 'ws://139.215.92.20:10013',
            ],
        ],
        // 健康检测、直播、日志上传ES推送服务器
        'server_general_push' => [
            [
                'src_addr' => 'ws://139.215.92.20:10009',
                'dest_addr' => 'ws://139.215.92.20:10009',
            ],
        ],
        // 音频适配服务器
        'audio_adapter' => [
            [
                'src_addr' => 'http://139.215.92.20:10008',
                'dest_addr' => 'http://139.215.92.20:10008',
            ],
        ],
        // APK2.0入口地址
        'epg_lws_for_apk' => [
