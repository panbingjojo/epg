...
if (ANDROID_SERVER_CONFIG_DEBUG) {
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
               'src_addr' => 'http://test-healthiptv.langma.cn:40037/09450001-guangxiyd-yiban/index.php',
               'dest_addr' => 'http://test-healthiptv.langma.cn:40037/09450001-guangxiyd-yiban//index.php',
            ],
        ],
        // 客服电话
...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://123.59.206.200:10002/epg-lws-for-apk-09450001/index.php',
                'dest_addr' => 'http://123.59.206.200:10002/epg-lws-for-apk-09450001/index.php',
            ],
        ],
        // 客服电话
        'customer_service_hotline' => [
