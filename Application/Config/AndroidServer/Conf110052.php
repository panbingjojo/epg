...
if (ANDROID_SERVER_CONFIG_DEBUG) {
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
               'src_addr' => 'http://test-healthiptv.langma.cn:40037/450001-guangxiyd/index.php',
               'dest_addr' => 'http://test-healthiptv.langma.cn:40037/450001-guangxiyd/index.php',
            ],
        ],
        // 客服电话
...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'server_cws' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn:10002',
                'dest_addr' => 'http://healthiptv.langma.cn:10002',
            ],
        ],
        // 消息推送服务器
        'server_push' => [
        ...
        'server_file_system' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn:10013/',
        ...
        'server_weather' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn:10002/cws/weather/?',
                'dest_addr' => 'http://healthiptv.langma.cn:10002/cws/weather/?',
            ],
        ],
        // 预约挂号服务器
        'server_guahao' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn:10014/',
        ...
        'server_stat' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn:10015/',
                'dest_addr' => 'http://healthiptv.langma.cn:10015/',
            ],
        ],
        // 崩溃跟踪服务器
        'server_crash' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn:10005/',
        ...
        'hosp_main_apis' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn:10000/apis?app_id=10002&amp;app_key=DcJL354uvIvEdvI9J2wc5Fq08ODjKBbW',
                'dest_addr' => 'http://healthiptv.langma.cn:10000/apis?app_id=10002&amp;app_key=DcJL354uvIvEdvI9J2wc5Fq08ODjKBbW',
            ],
        ],
        ...
        'audio_adapter' => [
            [
                'src_addr' => 'http://app.amx.langma.cn',
                'dest_addr' => 'http://healthiptv.langma.cn:10003',
            ],
        ],
        // APK2.0入口地址
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://healthiptv.langma.cn/epg-lws-for-apk-110052/index.php',
                'dest_addr' => 'http://healthiptv.langma.cn/epg-lws-for-apk-110052/index.php',
            ],
        ],
        // 客服电话
        'customer_service_hotline' => [
