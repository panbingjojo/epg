...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'server_cws' => [
            [
                'src_addr' => 'http://sddx.39health.visionall.cn:10021',
                'dest_addr' => 'http://sddx.39health.visionall.cn:10021',
            ],
        ],
        // 消息推送服务器
        'server_push' => [
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://sddx.39health.visionall.cn:10021/index.php',
                'dest_addr' => 'http://sddx.39health.visionall.cn:10021/index.php',
            ],
        ],
        // 客服电话
        'customer_service_hotline' => [
