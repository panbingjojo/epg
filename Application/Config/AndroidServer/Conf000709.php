...
if (ANDROID_SERVER_CONFIG_DEBUG) {
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://test-healthiptv.langma.cn:40037/000709-demo7/index.php',
                'dest_addr' => 'http://test-healthiptv.langma.cn:40037/000709-demo7/index.php',
            ],
        ],
        // 客服电话
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'server_guahao' => [
            [
                ...
                'dest_addr' => 'http://123.59.206.200:10014/',
            ],
        ],
        // 统计服务器
        'server_stat' => [
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://123.59.206.200:10002/epg-lws-for-apk-000709/index.php',
                'dest_addr' => 'http://123.59.206.200:10002/epg-lws-for-apk-000709/index.php',
            ],
        ],
        // 客服电话
