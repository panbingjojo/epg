...
// 正式服配置
    ...
    define("ANDROID_SERVER_CONFIG", json_encode([
        ...
        'server_cws' => [
            [
                'src_addr' => 'http://sddx.39health.visionall.cn:10018',
                'dest_addr' => 'http://sddx.39health.visionall.cn:10018',
            ],
        ],
        // 消息推送服务器
        'server_push' => [
        ...
        'hosp_stun' => [
            [
                ...
                'dest_addr' => 'turn:sddx.39health.visionall.cn:10000',
                'turn_username' => 'test',
                'turn_passwd' => 'testpwd',
            ],
        ],
        ...
        'epg_lws_for_apk' => [
            [
                'src_addr' => 'http://sddx.39health.visionall.cn:10018/epg-lws-for-apk/index.php',
                'dest_addr' => 'http://sddx.39health.visionall.cn:10018/epg-lws-for-apk/index.php',
            ],
        ],
        // 客服电话
        'customer_service_hotline' => [
