...
switch (USE_SERVER) {
    case 1:
        // 现网（用户环境）
        define('SERVER_ENTRY_ADDR', "http://sddx.39health.visionall.cn:10014"); // 提供给APK插件使用
        define('SERVER_URL', "http://192.168.0.80:10014/cws/index.php?");  // cws服务器访问地址
        define('RESOURCES_URL', "http://sddx.39health.visionall.cn:10002"); // 文件服务器访问地址
        define('REPORT_ORDER_INFO_URL', "http://192.168.0.80:10014/cws/report/index.php"); // 现网 - 上报订购信息
        define('QUERY_REPORT_USER_INFO_URL', "http://192.168.0.80:10014/cws/report/query.php");
        define('QUERY_CHECK_REPORT_USER_INFO_URL', "http://192.168.0.80:10014/cws/report/query_check.php");
        define('REPORT_ORDER_STATUS_URL', "http://192.168.0.80:10014/cws/report/query_report.php");

        // 问诊相关
        define('CWS_HLWYY_URL', "http://192.168.0.80:10014/cws/hlwyy/index.php"); // cws-hlwyy模块
        define("CWS_HLWYY_URL_OUT", "http://sddx.39health.visionall.cn:10014/cws/hlwyy/index.php"); // cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://192.168.0.80:10014/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://sddx.39health.visionall.cn:10014/cws/39hospital/index.php");//大专家头像外网地址
        define('ORDER_CALL_BACK_URL', SERVER_ENTRY_ADDR ."/cws/pay/shandongdx_haikan/callback/web_index.php");  //现网 - 订购通知回调地址
        define('SERVER_CONTROL_UNIT', "http://192.168.0.80:10008"); //落地电话控制中心地址

        // 39健康网
        define('CWS_39NET_URL', "http://127.0.0.1:10014/cws/39net/index.php"); // cws-39net模块
    ...
    case 2:
        ...
        // 问诊相关
        define('CWS_HLWYY_URL', "http://sddx.39health.visionall.cn:10014/cws/hlwyy/index.php"); // cws-hlwyy模块
        define("CWS_HLWYY_URL_OUT", "http://sddx.39health.visionall.cn:10014/cws/hlwyy/index.php"); // cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://sddx.39health.visionall.cn:10014/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://sddx.39health.visionall.cn:10014/cws/39hospital/index.php");//大专家头像外网地址
...
//        define('REDIS_LOCAL_IP', "10.254.30.100");
    ...
    case 4:
        ...
        // 39健康网
        define('CWS_39NET_URL', "http://223.221.36.146:10014/cws/39net/index.php"); // cws-39net模块
...
//        define('REDIS_LOCAL_IP', "10.254.30.100");
    ...
    case 5:
        // 现网（广电服务器）
        define('SERVER_ENTRY_ADDR', "http://sddx.39health.visionall.cn:10014"); // 提供给APK插件使用
        define('SERVER_URL', "http://127.0.0.1:10014/cws/index.php?");  // cws服务器访问地址
        define('RESOURCES_URL', "http://sddx.39health.visionall.cn:10002"); // 文件服务器访问地址
        define('REPORT_ORDER_INFO_URL', "http://127.0.0.1:10014/cws/report/index.php"); // 现网 - 上报订购信息
        define('QUERY_REPORT_USER_INFO_URL', "http://127.0.0.1:10014/cws/report/query.php");
        define('QUERY_CHECK_REPORT_USER_INFO_URL', "http://127.0.0.1:10014/cws/report/query_check.php");
        define('REPORT_ORDER_STATUS_URL', "http://127.0.0.1:10014/cws/report/query_report.php");

        // 问诊相关
        define('CWS_HLWYY_URL', "http://127.0.0.1:10014/cws/hlwyy/index.php"); // cws-hlwyy模块
        define("CWS_HLWYY_URL_OUT", "http://sddx.39health.visionall.cn:10014/cws/hlwyy/index.php"); // cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://127.0.0.1:10014/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://sddx.39health.visionall.cn:10014/cws/39hospital/index.php");//大专家头像外网地址
        define('ORDER_CALL_BACK_URL', "http://127.0.0.1:10014/cws/pay/shandongdx/callback/web_index.php");  //现网 - 订购通知回调地址
    ...
    case 6:
        // 本地外网测试
        define('SERVER_ENTRY_ADDR', "http://sddx.39health.visionall.cn:10014"); // 提供给APK插件使用
        define('SERVER_URL', "http://sddx.39health.visionall.cn:10014/cws/index.php?"); // cws服务器访问地址
        define('RESOURCES_URL', "http://sddx.39health.visionall.cn:10002"); // 文件服务器访问地址
        define('REPORT_ORDER_INFO_URL', "http://sddx.39health.visionall.cn:10014/cws/report/index.php");
        define('QUERY_REPORT_USER_INFO_URL', "http://sddx.39health.visionall.cn:10014/cws/report/query.php");
        define('QUERY_CHECK_REPORT_USER_INFO_URL', "http://sddx.39health.visionall.cn:10014/cws/report/query_check.php");
        define('REPORT_ORDER_STATUS_URL', "http://sddx.39health.visionall.cn:10014/cws/report/query_report.php");
