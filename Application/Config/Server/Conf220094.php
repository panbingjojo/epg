...
switch (USE_SERVER) {
    case 1:
        // 现网（用户环境）
        define('SERVER_ENTRY_ADDR', "http://139.215.92.20:10000"); // 提供给APK插件使用
        define('SERVER_URL', "http://139.215.92.20:10000/cws/index.php?"); // cws服务器访问地址
        define('RESOURCES_URL', "http://139.215.92.20:10003/fs"); // 文件服务器访问地址
        define('REPORT_ORDER_STATUS_URL', "http://139.215.92.20:10000/cws/report/query_report.php");
        define('ORDER_CALL_BACK_URL', "http://139.215.92.20:10000/cws/pay/jilingd/callback/index.php"); // 购结果上传到CWS
        define('REPORT_ORDER_INFO_URL', "http://139.215.92.20:10000/cws/report/index.php");
        define('QUERY_REPORT_USER_INFO_URL', "http://139.215.92.20:10000/cws/report/query.php");
        define('QUERY_CHECK_REPORT_USER_INFO_URL', "http://139.215.92.20:10000/cws/report/query_check.php");

        // 问诊模块
        define('CWS_HLWYY_URL', "http://139.215.92.20:10000/cws/hlwyy/index.php"); // cws-hlwyy模块
        define("CWS_HLWYY_URL_OUT", "http://139.215.92.20:10000/cws/hlwyy/index.php"); // cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://139.215.92.20:10000/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://139.215.92.20:10000/cws/39hospital/index.php");//大专家头像外网地址
        define('CWS_WXSERVER_URL', "http://139.215.92.20:10000/cws/wxserver"); // cws-wxserver模块
        define('CWS_WXSERVER_URL_OUT', "http://139.215.92.20:10000/cws/wxserver"); // cws-wxserver模块
        define('SERVER_CONTROL_UNIT', "http://139.215.92.20:10017"); //落地电话控制中心地址

        // 39健康网
        define('CWS_39NET_URL', "http://139.215.92.20:10000/cws/39net/index.php"); // cws-39net模块
