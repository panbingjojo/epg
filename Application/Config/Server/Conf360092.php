 ...
 * Date: 2019-03-27
 * Time: 14:43
 * Brief: 此文件（或类）用于记录江西电信EPG的服务器配置参数
 */
/**
 * USE_SERVER:
 * 1、表示现网
...
switch (USE_SERVER) {
    case 1:
        ...
        define('RESOURCES_URL', "http://59.53.85.199:10364/fs"); //现网 - 文件服务器访问地址
    ...
    case 2:
        ...
        define('RESOURCES_URL', "http://59.53.85.199:10364/fs");
    ...
    case 3:
        ...
        define('ORDER_CALLBACK', "http://222.85.144.70:8100/cws/pay/order/callback/jiangsudx_com/index.php");
    ...
    case 4:
        // VPN 走正式服
        define('SERVER_URL', "http://59.53.85.199:10363/cws/index.php?");  //现网 - cws服务器访问地址
        define('RESOURCES_URL', "http://59.53.85.199:10364/fs"); //现网 - 文件服务器访问地址
        define('ORDER_CALLBACK', "http://59.53.85.199:10363/cws/pay/order/callback/jiangsudx_com/index.php");  //现网 - 订购通知回调地址
        define('REPORT_ORDER_INFO_URL', "http://59.53.85.199:10363/cws/report/index.php"); // 现网 - 上报订购信息
        define('REDIS_LOCAL_IP', "10.254.30.100"); //redis本地服务器ip
        define('REDIS_LOCAL_PORT', "6379"); // redis本地服务器端口
