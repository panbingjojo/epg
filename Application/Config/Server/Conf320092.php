...
switch (USE_SERVER) {
    case 1:
        // 现网（用户环境）
        define('SERVER_URL', "http://127.0.0.1:10014/cws/index.php?");  //现网 - cws服务器访问地址
        define('RESOURCES_URL', "http://180.100.134.116:10014/fs"); //现网 - 文件服务器访问地址
        define('ORDER_CALL_BACK_URL', "http://127.0.0.1:10014/cws/pay/jiangsudx/callback/index.php");  //现网 - 订购通知回调地址
        ...
        define("CWS_HLWYY_URL_OUT", "http://180.100.134.116:10014/cws/hlwyy/index.php"); //  cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://127.0.0.1:10014/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://180.100.134.116:10014/cws/39hospital/index.php"); // 大专家头像外网地址
        define('CWS_WXSERVER_URL', "http://127.0.0.1:10014/cws/wxserver"); // cws-wxserver模块
        define('CWS_WXSERVER_URL_OUT', "http://180.100.134.116:10014/cws/wxserver"); // cws-wxserver模块
    ...
    case 2:
        // 现网进入3983 使用现网数据
        define('SERVER_URL', "http://180.100.134.116:10014/cws/index.php?");  //现网 - cws服务器访问地址
        define('RESOURCES_URL', "http://180.100.134.116:10014/fs"); //现网 - 文件服务器访问地址
        define('ORDER_CALL_BACK_URL', "http://180.100.134.116:10014/cws/pay/jiangsudx/callback/index.php");  //现网 - 订购通知回调地址
        define('REPORT_ORDER_INFO_URL', "http://180.100.134.116:10014/cws/report/index.php"); // 现网 - 上报订购信息
        ...
        // 问诊相关
        define('CWS_HLWYY_URL', "http://180.100.134.116:10014/cws/hlwyy/index.php"); // cws-hlwyy模块
        define("CWS_HLWYY_URL_OUT", "http://180.100.134.116:10014/cws/hlwyy/index.php"); //  cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://180.100.134.116:10014/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://180.100.134.116:10014/cws/39hospital/index.php"); // 大专家头像外网地址
        define('CWS_WXSERVER_URL', "http://180.100.134.116:10014/cws/wxserver"); // cws-wxserver模块
        define('CWS_WXSERVER_URL_OUT', "http://180.100.134.116:10014/cws/wxserver"); // cws-wxserver模块
        define('SERVER_CONTROL_UNIT', "http://180.100.134.116:10002"); // 落地电话控制中心地址

        // 39健康网
        define('CWS_39NET_URL', "http://180.100.134.116:10014/cws/39net/index.php"); // cws-39net模块
