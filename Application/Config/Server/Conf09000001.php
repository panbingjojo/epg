...
switch (USE_SERVER) {
    case 1:// 现网（用户环境）
        define('SERVER_HOST_ADDRESS', "http://123.59.206.200");                                      // cws服务器主机地址
        ...
        // define('APP_ROOT_PATH', "http://123.59.206.200:10002/epg-lws-for-apk-09000001");              // 应用入口地址,只有提供给外部链接才使用
        break;
    ...
    case 2: // 测试服30.100
        ...
        define('APP_ROOT_PATH', "http://test-healthiptv.langma.cn:40037/09000001-yb-health-unified");              // 应用入口地址,只有提供给外部链接才使用
        break;
}
...
define('CWS_WXSERVER_URL', SERVER_HOST . "h/cws/wxserver");                    // cws-微信模块
