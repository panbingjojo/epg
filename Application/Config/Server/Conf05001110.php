...
switch (USE_SERVER) {
    case 1:// 现网（用户环境）
        ...
        // define('APP_ROOT_PATH', "http://123.59.206.200:10002/epg-lws-for-apk-360001");              // 应用入口地址,只有提供给外部链接才使用
        break;
...
define('ORDER_CALL_BACK_URL', SERVER_HOST ."/cws/pay/weilaitv_touch/callback/index.php"); // 购结果上传到CWS
