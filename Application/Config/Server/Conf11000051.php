...
switch (USE_SERVER) {
    case 1:
        // 现网（用户环境）
        define('SERVER_ENTRY_ADDR', "http://202.99.114.152:30280"); // 提供给APK插件使用
        define('SERVER_URL', "http://172.16.51.2:30280/cws/index.php?"); // cws服务器访问地址
        define('RESOURCES_URL', "http://202.99.114.152:30214/fs"); // 文件服务器访问地址
        define('ORDER_CALL_BACK_URL', "http://172.16.51.2:30280/cws/pay/chinaunicom/callback/web_ld_index.php"); // 购结果上传到CWS
        define('ORDER_CALL_BACK_URL_EX', "http://172.16.51.2:30280/cws/pay/chinaunicom/callback/web2_index.php"); // 购结果上传到CWS -- 新订购接口的结果
        define('UNSUBSCRIBE_VIP_CALL_BACK_URL', "http://172.16.51.2:30280/cws/pay/chinaunicom/callback/web_unsub_index.php"); // 退订上报结果（使用订购接口来处理）
        define('CANCEL_VIP_CALL_BACK_URL', "http://172.16.51.2:30280/cws/pay/chinaunicom/callback/web_unsub2_index.php"); // 退订上报结果（新的退订接口）
        define('REPORT_ORDER_INFO_URL', "http://172.16.51.2:30280/cws/report/index.php");
        define('QUERY_REPORT_ORDER_INFO_URL', "http://172.16.51.2:30280/cws/pay/chinaunicom/callback/order_query.php"); // 查询上报哪家的订购url
        define('QUERY_REPORT_USER_INFO_URL', "http://172.16.51.2:30280/cws/report/query.php");
        define('QUERY_CHECK_REPORT_USER_INFO_URL', "http://172.16.51.2:30280/cws/report/query_check.php");
        define('REPORT_ORDER_STATUS_URL', "http://172.16.51.2:30280/cws/report/query_report.php");

        // 问诊模块
        define('CWS_HLWYY_URL', "http://172.16.51.2:30280/cws/hlwyy/index.php"); // cws-hlwyy模块
        define("CWS_HLWYY_URL_OUT", "http://202.99.114.152:30280/cws/hlwyy/index.php"); // cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://172.16.51.2:30280/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://202.99.114.152:30280/cws/39hospital/index.php");//大专家头像外网地址
        define('CWS_WXSERVER_URL', "http://172.16.51.2:30280/cws/wxserver"); // cws-wxserver模块
        define('CWS_WXSERVER_URL_OUT', "http://202.99.114.152:30280/cws/wxserver"); // cws-wxserver模块

        // 39健康网
        define('CWS_39NET_URL', "http://172.16.51.2:30280/cws/39net/index.php"); // cws-39net模块
        ...
        define('APP_ROOT_PATH', "http://202.99.114.152:30281");            //  应用入口地址
        break;
    case 2:
        // 现网进入3983
