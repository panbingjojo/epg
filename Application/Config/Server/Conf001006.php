...
switch (USE_SERVER) {
    case 1: // 现网（用户环境）
        ...
        // define('APP_ROOT_PATH', SERVER_HOST . "/epg-lws-for-apk-001006");         // LWS访问地址
        //define('APP_ROOT_PATH', "http://test-healthiptv.langma.cn:40037/001006-chinaunicom-ott");         // LWS访问地址
        break;
