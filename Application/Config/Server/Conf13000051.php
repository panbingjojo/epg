...
switch (USE_SERVER) {
    case 1:
        // 现网（用户环境）
        define('SERVER_ENTRY_ADDR', "http://202.99.114.152:30202"); // 提供给APK插件使用
        define('SERVER_URL', "http://172.16.51.2:30202/cws/index.php?"); // cws服务器访问地址
        define('RESOURCES_URL', "http://202.99.114.152:30214/fs"); // 文件服务器访问地址
        define('ORDER_CALL_BACK_URL', "http://172.16.51.2:30202/cws/pay/chinaunicom/callback/web_yjsh_index.php"); // 购结果上传到CWS
        define('UNSUBSCRIBE_VIP_CALL_BACK_URL', "http://172.16.51.2:30202/cws/pay/chinaunicom/callback/web_unsub_index.php"); // 退订上报结果（使用订购接口来处理）
        define('CANCEL_VIP_CALL_BACK_URL', "http://172.16.51.2:30202/cws/pay/chinaunicom/callback/web_unsub2_index.php"); // 退订上报结果（新的退订接口）
        define('REPORT_ORDER_INFO_URL', "http://172.16.51.2:30202/cws/report/index.php");
        define('QUERY_REPORT_ORDER_INFO_URL', "http://172.16.51.2:30202/cws/pay/chinaunicom/callback/order_query.php"); // 查询上报哪家的订购url
        define('QUERY_REPORT_USER_INFO_URL', "http://172.16.51.2:30202/cws/report/query.php");
        define('QUERY_CHECK_REPORT_USER_INFO_URL', "http://172.16.51.2:30202/cws/report/query_check.php");
        define('REPORT_ORDER_STATUS_URL', "http://172.16.51.2:30202/cws/report/query_report.php");
        ...
        define('APP_ROOT_PATH', "http://202.99.114.152:30200");            //  应用入口地址
        break;
    case 2:
        // 现网进入3983
        ...
        define('ORDER_CALL_BACK_URL', "http://222.85.144.70:8100/cws/pay/chinaunicom/callback/web_yjsh_index.php"); // 购结果上传到CWS
    ...
    case 3:
        ...
        define('RESOURCES_URL', "http://222.85.144.70:8091"); // 文件服务器访问地址
        define('ORDER_CALL_BACK_URL', "http://10.254.30.100:8100/cws/pay/chinaunicom/callback/web_yjsh_index.php"); // 购结果上传到CWS
...
//        define('SERVER_CONTROL_UNIT', "http://202.99.114.152:30279"); //落地电话控制中心地址
    ...
    case 4:
        // 线上本地内网访问
        define('SERVER_ENTRY_ADDR', "http://202.99.114.152:30202"); // 提供给APK插件使用
        define('SERVER_URL', "http://202.99.114.152:30202/cws/index.php?"); // cws服务器访问地址
        define('RESOURCES_URL', "http://202.99.114.152:30214/fs"); // 文件服务器访问地址
        define('ORDER_CALL_BACK_URL', "http://202.99.114.152:30202/cws/pay/chinaunicom/callback/web_yjsh_index.php"); // 购结果上传到CWS
        define('UNSUBSCRIBE_VIP_CALL_BACK_URL', "http://202.99.114.152:30202/cws/pay/chinaunicom/callback/web_unsub_index.php"); // 退订上报结果（使用订购接口来处理）
        define('CANCEL_VIP_CALL_BACK_URL', "http://202.99.114.152:30202/cws/pay/chinaunicom/callback/web_unsub2_index.php"); // 退订上报结果（新的退订接口）
        define('REPORT_ORDER_INFO_URL', "http://202.99.114.152:30202/cws/report/index.php");
        define('QUERY_REPORT_ORDER_INFO_URL', "http://202.99.114.152:30202/cws/pay/chinaunicom/callback/order_query.php"); // 查询上报哪家的订购url
        define('QUERY_REPORT_USER_INFO_URL', "http://202.99.114.152:30202/cws/report/query.php");
        define('QUERY_CHECK_REPORT_USER_INFO_URL', "http://202.99.114.152:30202/cws/report/query_check.php");
        define('REPORT_ORDER_STATUS_URL', "http://202.99.114.152:30202/cws/report/query_report.php");

        // 39健康网
        define('CWS_39NET_URL', "http://202.99.114.152:30202/cws/39net/index.php"); // cws-39net模块
