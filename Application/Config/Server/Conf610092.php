...
switch (USE_SERVER) {
    case 1:
        ...
        define('RESOURCES_URL', "http://113.136.205.44:10082/fs"); //现网 - 文件服务器访问地址
        define('ORDER_CALLBACK', "http://127.0.0.1:10000/cws/pay/shanxidx/callback/index.php");  //现网 - 聚精彩订购通知回调地址
        define('ORDER_CALL_BACK_URL', "http://127.0.0.1:10000/cws/pay/shanxidx/callback/index-vip-2.php");
        ...
        define("CWS_HLWYY_URL_OUT", "http://113.136.205.44:10081/cws/hlwyy/index.php"); //  cws-hlwyy模块 外网地址
        define("CWS_EXPERT_URL", "http://127.0.0.1:10000/cws/39hospital/index.php");
        define("CWS_EXPERT_URL_OUT", "http://113.136.205.44:10081/cws/39hospital/index.php"); // 大专家头像外网地址
        define('CWS_WXSERVER_URL', "http://127.0.0.1:10000/cws/wxserver"); // cws-wxserver模块
        define('CWS_WXSERVER_URL_OUT', "http://113.136.205.44:10081/cws/wxserver"); // cws-wxserver模块 -- 页面
    ...
    case 3:
        ...
        define('ORDER_CALLBACK', "10.254.30.100:8100/cws/pay/shanxidx/callback/index.php");  //现网 - 聚精彩订购通知回调地址
    ...
    case 5:
        // 测试现网（用户环境）
        define('SERVER_URL', "http://123.59.206.199:50010/cws/index.php?");  //现网 - cws服务器访问地址
        define('RESOURCES_URL', "http://123.59.206.199:20003/fs"); //现网 - 文件服务器访问地址
        define('ORDER_CALLBACK', "http://123.59.206.199:50010/cws/pay/order/callback/jiangsudx_com/index.php");  //现网 - 聚精彩订购通知回调地址
