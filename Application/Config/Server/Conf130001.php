...
switch (USE_SERVER) {
    case 1:// 现网（用户环境）
        define('SERVER_HOST_ADDRESS', "http://healthiptv.langma.cn");                                // cws服务器主机地址
...
//         define('APP_ROOT_PATH', "http://healthiptv.langma.cn/epg-lws-for-apk-130001");              // 应用入口地址,只有提供给外部链接才使用
        break;
...
//        define('APP_ROOT_PATH', "http://healthiptv.langma.cn/epg-lws-for-apk-130001");
        break;
}
