 ...
 */
//正式订购相关参数
define("productID_10", '83000001'); // “包月”在局方注册的产品id，用于此产品的单独订购
...
define("PRODUCT_PRICE_7", 900);//计费金额 //局方配置的9元钱，这个值以分计算
...
//暖春活动透传订购接口
define('PUSH_ORDER_LOG_URL', "http://49.117.145.226:39595/xinjiang-commonActivity/order/api/addOrderLog");
//暖春活动订购更新金币接口
define('UPDATE_LEARNING_COIN_URL', "http://49.117.145.226:39595/xinjiang-commonActivity/learnCoin/api/updateLearnCoinOrder");
