...
// 天津魔方小包计费信息
//define('SERVICE_ID_SMALL_BAG', "tjlnbzxwzfw");           // 服务ID -- 天津专用
//define('CONTENT_ID_SMALL_BAG', "tjlnbzxwz");          // 内容ID -- 天津专用
//define('PRODUCT_ID_SMALL_BAG', "tjlnbzxwzac005@201");       // 产品ID -- 天津专用
define('SERVICE_ID_SMALL_BAG', "lnbzxwzfw");           // 服务ID -- 天津专用
define('CONTENT_ID_SMALL_BAG', "");          // 内容ID -- 天津专用
define('PRODUCT_ID_SMALL_BAG', "tjlnbzxwzby005@201");       // 产品ID -- 天津专用



// 山西联通
define('SHANXI_SPID', "79474");                    // 合作伙伴ID
define('SERVICE_SHANXI_ID', "shpdshdb");           // 服务ID -- 山西线下大包专用
define('CONTENT_SHANXI_ID', "");                   // 内容ID -- 山西线下大包专用
define('PRODUCT_SHANXI_ID', "shpdshdb1@207");      // 产品ID --山西线下大包专用

/***************************************2021-02-25割接到新平台--老地址****************************************
define('ORDER_AUTHORIZATION_URL', "http://202.99.114.14:35820/ACS/vas/authorization"); //正式  用户鉴权接口
define('ORDER_VERIFY_USER_URL', "http://202.99.114.14:35820/ACS/vas/verifyuser"); //正式  用户鉴权接口
define('ORDER_SERVICE_ORDER_URL', "http://202.99.114.14:35820/ACS/vas/serviceorder"); //正式  用户身份确定
define('ORDER_SERVICE_QUERY_ORDER_PRODUCT_URL', "http://202.99.114.28:10000/getOrders"); //正式  获取已订购产品列表接口
...
// 数据上报相关
define('CPID', "gzqsxxjsyxgs");  // 合作伙伴ID
define('CPKEY', "e1109e6192858d2ecf09ddab8911c");  // 合作伙伴密钥
...
define('PAY_AUTH_KEY', 'dda976a3df663d25');

// 统一播放器收藏、播放记录等接口请求地址
define('UNIFIED_PLAYER_REQUEST_URL', 'http://202.99.114.14:8081/');
