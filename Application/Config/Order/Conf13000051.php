...
define('SERVICE_ID', "lbqdshby20");          // 服务ID
define('CONTENT_ID', "lbqdsh");          // 内容ID
define('PRODUCT_ID', "lbqdshby20");             // 产品ID 【鉴权时不带@地区码】 天津：sjjklx@201 山东：sjjklx@216 山西: sjjklx@207 黑龙江：sjjklx@211 河北: sjjklx@206 辽宁: sjjklx@209 内蒙: sjjklx@208
...
// 黑龙江商品ID编号
define("PRODUCT_ID_20", 1); // “遇见生活20元续包月”在局方注册的产品id，用于此产品的单独订购
define("PRODUCT_ID_30", 2); // “遇见生活30元包30天”在局方注册的产品id，，用于此产品的单独订购
