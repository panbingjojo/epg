...
define('SERVICE_ID', "sjjkby015");          // 服务ID
define('CONTENT_ID', "sjjklinux");          // 内容ID
define('PRODUCT_ID', "sjjklx");             // 产品ID 【鉴权时不带@地区码】 天津：sjjklx@201 山东：sjjklx@216 山西: sjjklx@207 黑龙江：sjjklx@211 河北: sjjklx@206 辽宁: sjjklx@209 内蒙: sjjklx@208
...
//食乐汇天津5元小包
define('SERVICE_ID_SMALL_BAG', "tjlnbmsfw");           // 服务ID -- 天津专用
define('CONTENT_ID_SMALL_BAG', "tjlnbms");          // 内容ID -- 天津专用
define('PRODUCT_ID_SMALL_BAG', "tjlnbmsac005@201");       // 产品ID -- 天津专用
...
define('PRODUCT_SHANXI_ID', "shpdshdbslh@207");    // 产品ID --山西线下大包专用
