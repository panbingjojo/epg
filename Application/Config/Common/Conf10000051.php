...
define("UPLOAD_USER_BEHAVIOUR_POSITION_DATA", "return array(
    '201' => '天津-朗玛信息-健康魔方-13', // 天津独立入口13
    '216' => '山东-朗玛信息-健康魔方-03', // 山东独立入口03
    '211' => '黑龙江-朗玛信息-健康魔方-03', // 黑龙江信息聚合入口产品
);");
...
// 用户行为上报链接地址
define("USER_BEHAVIOUR_REPORT_URL","http://202.99.114.28:10000/externalDataNotify");
// 用户上报的来源 -- 针对局方，该值也是局方分配的
define("OUT_SOURCE","70");
