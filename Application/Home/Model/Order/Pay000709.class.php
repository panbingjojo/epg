...
class Pay000709 extends PayAbstract
{
    /**
    ...
    public function buildPayInfo($payInfo = null)
    {
        ...
        if ($orderInfo->result != 0) {
            ...
            $ret['message'] = "创建订单失败";
            LogUtils::info("pay000006::buildPayUrl() ---> 获取订单失败：" . $ret['result']);
            return $ret;
        }
        //获取订单成功
    ...
    public function payCallback($payResultInfo = null)
    {
        ...
        LogUtils::info(" payCallback 000006 ---> payResult: " . json_encode($payResultInfo));
