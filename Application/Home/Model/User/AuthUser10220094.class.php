...
class AuthUser10220094 extends BaseAuthUser
{
    public function auth()
    {
        ...
        if(CARRIER_ID == CARRIER_ID_JILINGD_MOFANG){ // 吉林广电联通 -- 查询更新续订字段
    ...
    private function _setEPGParams()
    {
        ...
        $areaCode = "";
        $pattern = CARRIER_ID == CARRIER_ID_JILINGD_MOFANG ? "/^(86)*043[1-9]/" : "/^(iptv)*043[1-9]/";
